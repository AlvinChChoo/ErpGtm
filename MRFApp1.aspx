...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select SM.Model_No,MM.MRF_NO,MM.JO_No,MM.P_Level,MM.Submit_By,MM.Submit_Date,MM.App1_By,MM.App2_By,MM.App3_By,MM.App4_By,MM.App1_Date,MM.App2_Date,MM.App3_Date,MM.App4_Date,MM.MRF_Status,JM.Lot_No from MRF_M MM,Job_Order_M JM,SO_Models_M SM where mm.jo_no = jm.jo_no and jm.lot_no = sm.lot_no and mm.submit_date is not null order by MRF_No desc"
    ...
    Sub ShowMRF(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("MRFApp1Det.aspx?ID=" & SeqNo)
    End sub
            ...
            <table style="HEIGHT: 16px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label3" runat="server" width="100%" cssclass="FormDesc">MATERIAL RETURN
                                FORM</asp:Label>
                            </p>
                            <p align="center">
