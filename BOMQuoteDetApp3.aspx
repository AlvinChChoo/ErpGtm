...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.isPostBack = false then
            ...
            LoadDataHeader
            procLoadGridData ()
            lblTargetCost.text = ReqCOM.GetFieldVal("select sum(std_up*P_Usage) as [TargetCost] from bom_quote_d where BOM_Quote_No = '" & trim(lblBOMQuoteNo.text) & "';","TargetCost")
    ...
    Sub cmdCancel_Click(sender As Object, e As EventArgs)
        response.redirect("BOMQuoteApp3.aspx")
    End Sub
    ...
    Sub ShowDet(sender as Object,e as DataGridCommandEventArgs)
        ...
        if trim(ucase(e.commandArgument)) = "VIEW" then Response.redirect("BOMQuotePartDetApp3.aspx?ID=" & trim(SeqNo.text))
