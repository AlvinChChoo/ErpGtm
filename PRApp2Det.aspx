...
<script runat="server">
    ...
    Sub cmdSubmit_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            MReceiver = ReqCOM.GetFieldVal("Select U_ID from authority where Module_Name = 'PR' and app_type = 'APP3'","U_ID")
    ...
    Sub GeneratePendingEmailList(Sender as string, Receiver as string,DOcNo as string)
        ...
        EmailContent = EmailContent + "There is a New P/R pending for your approval(P/R # : " & trim(DOcNo) & ")." & vblf & vblf
        EmailContent = EmailContent + "Click on http://gtekapp/erp/signin.aspx?ReturnURL=PRApp3Det.aspx?ID=" & ReqCOM.GetFieldVal("Select Seq_No from PR1_M where PR_No = '" & trim(DOcNo) & "';","Seq_No") & " to view the details." & vblf & vblf
                                                ...
                                                <p>
                                                    <table style="HEIGHT: 17px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td width="25%">
                                                                    <asp:Button id="cmdSubmit" onclick="cmdSubmit_Click" runat="server" Width="180px" CssClass="OutputText" Text="Submit"></asp:Button>
                                                                </td>
                                                                <td width="25%">
                                                                    <div align="center">
                                                                        <asp:Button id="cmdReject" onclick="cmdReject_Click" runat="server" Width="180px" CssClass="OutputText" Text="REJECT Selected Item" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                                <td width="25%">
                                                                    <div align="center">
                                                                        <asp:Button id="cmdRemove" onclick="cmdRemove_Click" runat="server" Width="180px" CssClass="OutputText" Text="REMOVE Selected Item" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                                <td width="25%">
                                                                    <div align="right">
                                                                        <asp:Button id="cmdBack" onclick="cmdBack_Click" runat="server" Width="180px" CssClass="OutputText" Text="Back"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
