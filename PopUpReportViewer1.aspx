        ...
        Sub ShowReport()
            ...
            select case ucase(RptnAME)
                ...
                Case "POOUTSTANDINGBYPONO"
                    CrystalReportViewer1.SelectionFormula = "{PO_M.PO_No} >= '" & trim(request.params("POFrom")) & "' and {PO_M.PO_No} <= '" & trim(request.params("POTo")) & "'  and {PO_D.bal_qty} > 0"
                Case "MIFTRANSRPT"
                ...
                Case "MRPALLOCATION" :
                    'CrystalReportViewer1.SelectionFormula = "{MRP_PART_ALLOCATION.ind} = 'Y'"
                ...
                Case "PENYATABORANGKASTAM"
                    ...
                    StesenImport = crFormulas.Item("StesenImport") : StesenImport.text = "'" & request.params("ExpDesc") & "'"
    
                    'CrystalReportViewer1.SelectionFormula = "{MIF_M.Custom_Exp} = '" & trim(request.params("CustomExp")) & "'"
    
                    'CrystalReportViewer1.SelectionFormula = "{MIF_M.Custom_Exp} = '" & trim(request.params("CustomExp")) & "' and Year ({MIF_M.MIF_DATE}) = " & trim(request.params("MIFYear")) & ""
