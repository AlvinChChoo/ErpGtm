...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        Dim StrSql as string
            ...
            StrSql = "Select * from merf_m where submit_date is not null order by MERF_NO desc"
    ...
    Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            if trim(SubmitDate.text) <> "" then SubmitBy.text = SubmitBy.text & " - " & format(cdate(SubmitDate.text),"dd/MMM/yy")
            ...
            if trim(App3Date.text) <> "" then App3By.text = App3By.text & " - " & format(cdate(App3Date.text),"dd/MMM/yy")
    ...
    Sub ShowMRF(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("MERFDet.aspx?ID=" & SeqNo)
    End sub
