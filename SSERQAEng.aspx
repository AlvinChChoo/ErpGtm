...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        if cmbSearch.selecteditem.value = "SSER_NO" then
            StrSql = "Select * from sser_m where SSER_NO like '%" & trim(txtSearch.text) & "%' and me_hod_date is not null and sser_stat <> 'REJECTED' order by seq_no desc"
        elseif cmbSearch.selecteditem.value = "PART_NO" then
            StrSql = "Select * from sser_m where Part_No_From + Part_No_To like '%" & trim(txtSearch.text) & "%' and me_hod_date is not null and sser_stat <> 'REJECTED' order by seq_no desc"
        end if
    ...
    Sub ShowSSER(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("SSERQAEngDet.aspx?ID=" & SeqNo)
    End sub
                                                    ...
                                                    <table style="HEIGHT: 11px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    &nbsp; <asp:Label id="Label2" runat="server" cssclass="OutputText" width="100%">Urgent
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    &nbsp; <asp:Label id="Label3" runat="server" cssclass="OutputText" width="100%">Normal
                                                                    Part Approval</asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="white">
                                                                ...
                                                                <td>
                                                                    &nbsp; <asp:Label id="Label4" runat="server" cssclass="OutputText" width="100%">Completed
                                                                    Part Approval</asp:Label></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
