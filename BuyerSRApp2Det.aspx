...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Sub cmdBack_Click(sender As Object, e As EventArgs)
            Response.redirect("buyerSRApp2.aspx")
        End Sub
        ...
        Sub cmdApprove_Click(sender As Object, e As EventArgs)
            ...
            if rbApprove.checked = true then
                ReqCOM.ExecuteNonQuery("Update Buyer_SR_M set App2_By = '" & trim(request.cookies("U_ID").value) & "',App2_Date = '" & now & "',App2_Rem = '" & trim(txtRem.text) & "',App2_Status='Y' where SR_No = '" & trim(lblSRNo.text) & "';")
                MReceiver = ReqCOM.GetFieldVal("Select EMail from User_Profile where U_ID in (Select U_ID from authority where app_type = 'APP3' and module_name = 'BUYERSR')","Email")
            ...
            elseif rbReject.checked = true then
                ReqCOM.ExecuteNonQuery("Update Buyer_SR_M set App2_By = '" & trim(request.cookies("U_ID").value) & "',App2_Date = '" & now & "',App2_Rem = '" & trim(txtRem.text) & "',App2_Status='N',sr_status = 'REJECTED' where SR_No = '" & trim(lblSRNo.text) & "';")
                ShowAlert ("Selected SR has been rejected.")
            end if
            redirectPage("BuyerSRApp2Det.aspx?ID=" & Request.params("ID"))
        End Sub
    ...
    Sub GenerateMail(Sender as string, Receiver as string,CC as string,DOcNo as string,SRStatus as string)
        ...
        if SRStatus = "Y" then
            ...
            StrMsg = StrMsg + "Click on http://gtekapp/erp/signin.aspx?ReturnURL=BuyerSRApp3Det.aspx?ID=" & ReqCOM.GetFieldVal("Select Seq_No from Buyer_SR_M where SR_NO = '" & trim(DOcNo) & "';","Seq_No") & " to view the details."   & vblf & vblf
                                            ...
                                            <td>
                                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label id="lblRemarks" runat="server" width="" cssclass="OutputText"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td bgcolor="silver" rowspan="2">
