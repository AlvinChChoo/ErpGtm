...
<script runat="server">
    ...
    sub LoadProductDetails()
        ...
        lblFileName.text = ReqCOM.GetFieldVal("Select * from FECN_Attachment where Seq_No = " & request.params("ID") & ";","File_Name")
        ...
        Response.WriteFile(Mappath("") + "\FECNAttachment\" + trim(lblFileName.text))
        Response.Flush()
