...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        if cmbSearch.selecteditem.value = "UPAS_NO" then StrSql = "SELECT * FROM UPAS_M WHERE UPAS_NO LIKE '%" & txtSearch.Text & "%' and upas_status like '%" & trim(cmbUPAStatus.selecteditem.value) & "%' ORDER BY upas_no desc"
        ...
        if cmbSearch.selecteditem.value = "VEN_CODE" then StrSql = "SELECT * FROM UPAS_M WHERE UPAS_NO in (SELECT UPAS_NO FROM UPAS_D WHERE VEN_CODE IN(Select VEN_CODE from VENDOR where VEN_CODE + VEN_NAME like '%" & trim(txtSearch.text) & "%'))  and upas_status like '%" & trim(cmbUPAStatus.selecteditem.value) & "%' ORDER BY upas_no desc"
        ...
        if cmbSearch.selecteditem.value = "PART_NO" then
            ...
            if txtSearch.text <> "" then StrSql = "SELECT * FROM UPAS_M WHERE UPAS_NO in (Select UPAS_NO from UPAS_D where Part_No like '%" & trim(txtSearch.text) & "%') and Submit_by is not null and upas_status <> 'REJECTED' and upas_status like '%" & trim(cmbUPAStatus.selecteditem.value) & "%' ORDER BY upas_no desc"
        End if
    ...
    Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            Dim Purc As Label = CType(e.Item.FindControl("Purc"), Label)
            ...
            if trim(Purc.text) = "" then
                if trim(Urgent.text) = "Y" then e.item.cssclass = "Urgent" else e.Item.CssClass = "PartSource"
            end if
    ...
    Sub ItemCommand(sender as Object,e as DataGridCommandEventArgs)
        ...
        if ucase(e.commandArgument) = "VIEW" then Response.redirect("UPAAppDet.aspx?ID=" & clng(SeqNo.text))
    end sub
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="SideTableHeading" background="Frame-Top-Center.jpg">
                                                                    Unit Price Approval (UPA) List</td>
                                                    ...
                                                    <table class="sideboxnotopGrey" cellspacing="0" cellpadding="0" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div align="center">
                                                                        <table style="HEIGHT: 12px" width="98%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div align="center"><asp:Label id="Label3" runat="server" cssclass="OutputText">SEARCH</asp:Label>&nbsp;<asp:TextBox id="txtSearch" runat="server" Width="123px" CssClass="OutputText"></asp:TextBox>
                                                                                            &nbsp;<asp:Label id="Label2" runat="server" cssclass="OutputText">BY</asp:Label>&nbsp;<asp:DropDownList id="cmbSearch" runat="server" Width="143px" CssClass="OutputText" OnSelectedIndexChanged="cmbSearch_SelectedIndexChanged">
                                                                                                <asp:ListItem Value="UPAS_NO">UPA No</asp:ListItem>
                                                                                            ...
                                                                                            &nbsp; <asp:Label id="Label7" runat="server" cssclass="OutputText">SHOW</asp:Label>&nbsp;<asp:DropDownList id="cmbUPAStatus" runat="server" Width="139px" CssClass="OutputText">
                                                                                            ...
                                                                                            &nbsp;&nbsp;<asp:Button id="Button3" onclick="Button3_Click" runat="server" Width="66px" CssClass="OutputText" Text="GO"></asp:Button>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <asp:DataGrid id="GridControl1" runat="server" width="98%" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" Font-Names="Verdana" OnItemCommand="ItemCommand" AllowPaging="True" BorderColor="Black" cellpadding="4" ShowFooter="True" AutoGenerateColumns="False" Font-Name="Verdana" OnItemDataBound="FormatRow" OnPageIndexChanged="OurPager" PageSize="20" PagerStyle-NextPageText="Next" PagerStyle-PrevPageText="Prev" PagerStyle-HorizontalAligh="Right">
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderText="Purchasing">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label id="Purc" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "PURC_BY") %>' /> - <asp:Label id="PurcDate" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Purc_Date") %>' /> <asp:Label id="SeqNo" runat="server" visible= "false" text='<%# DataBinder.Eval(Container.DataItem, "Seq_No") %>' /> 
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderText="Action">
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <asp:ImageButton id="ImgView" ToolTip="View this UPA" ImageUrl="View.gif" CommandArgument='VIEW' runat="server"></asp:ImageButton>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                </Columns>
                                                                            </asp:DataGrid>
