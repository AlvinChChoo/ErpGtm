    ...
    Sub cmdSubmit_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            if trim(cmbElecPIC.selecteditem.value) <> "" then
                ...
                GenerateMail(MSender,MReceiver,CC,trim(lblFECNNo.text),"MECH")
            ...
            if trim(cmbMechPIC.selecteditem.value) <> "" then
                ...
                MSender = ReqCOM.GetFieldVal("Select EMail from User_Profile where U_ID = '" & trim(request.cookies("U_ID").value) & "';","Email")
                GenerateMail(MSender,MReceiver,CC,trim(lblFECNNo.text),"ELEC")
                                ...
                                <table style="HEIGHT: 11px" cellspacing="0" cellpadding="0" width="98%">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    <asp:CustomValidator id="PIC" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have select a valid Electrical or Mechanical PIC." Display="Dynamic" ForeColor=" " EnableClientScript="False" OnServerValidate="PIC_ServerValidate"></asp:CustomValidator>
                                                    <asp:CustomValidator id="CustomValidator1" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid reason of change." Display="Dynamic" ForeColor=" " EnableClientScript="False" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
                                                </p>
                                                <p>
                                                                    ...
                                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: white; BORDER-BOTTOM-COLOR: white; BORDER-TOP-COLOR: white; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: white" width="100%" align="center" border="1">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label id="lblFECNNo" runat="server" width="" font-size="Larger" font-bold="True"></asp:Label></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                ...
                                                                                <td>
                                                                                    <p align="left">
                                                                                        <asp:Label id="lblModelNo" runat="server" width="423px" font-size="Larger" font-bold="True"></asp:Label>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label15" runat="server" width="116px" cssclass="LabelNormal">PCBA Rev.
                                                                                    From</asp:Label></td>
                                                                                <td>
                                                                                    <asp:TextBox id="txtPCBRevFrom" runat="server" CssClass="OutputText" Width="241px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label22" runat="server" width="116px" cssclass="LabelNormal">PCBA Rev.
                                                                                    To</asp:Label></td>
                                                                                <td>
                                                                                    <asp:TextBox id="txtPCBRevTo" runat="server" CssClass="OutputText" Width="241px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                ...
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:TextBox id="txtECNNo" onkeydown="GetFocusWhenEnter(txtCustECNNo)" onclick="GetFocus(txtECNNo)" runat="server" CssClass="OutputText" Width="241px"></asp:TextBox>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:TextBox id="txtCustECNNo" onkeydown="GetFocusWhenEnter(txtPartListNo)" onclick="GetFocus(txtCustECNNo)" runat="server" CssClass="OutputText" Width="241px"></asp:TextBox>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:TextBox id="txtPartListNo" onclick="GetFocus(txtPartListNo)" runat="server" CssClass="OutputText" Width="241px"></asp:TextBox>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label11" runat="server" width="126px" cssclass="LabelNormal">Electrical
                                                                                    (PIC)</asp:Label></td>
                                                                                <td>
                                                                                    <asp:DropDownList id="cmbElecPIC" runat="server" CssClass="outputText" Width="241px"></asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label12" runat="server" width="126px" cssclass="LabelNormal">Mechanical
                                                                                    (PIC)</asp:Label></td>
                                                                                <td>
                                                                                    <asp:DropDownList id="cmbMechPIC" runat="server" CssClass="outputText" Width="241px"></asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label13" runat="server" width="124px" cssclass="LabelNormal">Reason
                                                                                ...
                                                                                <td>
                                                                                    <p>
                                                                                        ...
                                                                                        &nbsp; 
                                                                                        <asp:TextBox id="txtOthers" runat="server" CssClass="OutputText" Width="152px"></asp:TextBox>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label14" runat="server" width="124px" cssclass="LabelNormal">Prepared
                                                                                    By</asp:Label></td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label4" runat="server" width="124px" cssclass="LabelNormal">Submit
                                                                                    By</asp:Label></td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label3" runat="server" width="124px" cssclass="LabelNormal">Remarks</asp:Label></td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left"><asp:Label id="lblApp6Rem" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                        ...
                                                                        <table style="HEIGHT: 12px" cellspacing="0" cellpadding="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div align="left">
                                                                                            <asp:Button id="cmdRefreshAtt" onclick="cmdRefreshAtt_Click" runat="server" CssClass="OutputText" Width="190px" Text="Refresh Attachment List" CausesValidation="False"></asp:Button>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div align="right">
                                                    ...
                                                    <table style="HEIGHT: 12px" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:LinkButton id="lnkNewMainPart" onclick="lnkNewMainPart_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False">Click here to add new Main Part</asp:LinkButton>
                                                                        <asp:LinkButton id="lnkRemoveMainPart" onclick="lnkRemoveMainPart_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False">Click here to remove Main Part</asp:LinkButton>
                                                                        <asp:LinkButton id="lnkEditPart" onclick="lnkEditPart_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False">Click here to edit BOM Details (e.g. Part No,Location, Usage, Level, add and remove alternate part)</asp:LinkButton>
                                                                        <asp:LinkButton id="LinkButton4" onclick="LinkButton4_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False" Visible="False">Click here to add new Alternate Part</asp:LinkButton>
                                                                        <asp:LinkButton id="lnkRemoveAltPart" onclick="lnkRemoveAltPart_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False" Visible="False">Click here to remove Alternate Part</asp:LinkButton>
                                                                        <asp:LinkButton id="lnkPartDetails" onclick="lnkPartDetails_Click" runat="server" CssClass="OutputText" Width="100%" Enabled="False">Click here to edit part details (e.g. Specification, Description, MPN)</asp:LinkButton>
                                                                    </p>
                                                                    <p align="center">
                                                                        <asp:DataList id="MyList" runat="server" Width="100%" OnSelectedIndexChanged="MyList_SelectedIndexChanged" OnItemCommand="ShowSelection" Height="101px" CellPadding="1" BorderWidth="0px" RepeatColumns="1" Font-Size="XX-Small" Font-Names="Arial">
