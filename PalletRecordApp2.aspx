...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select pm.pallet_status,pm.seq_no,PM.ppr_no,PM.jo_no,submit_by,submit_date,app1_by,app1_date,app2_by,app2_date from pallet_Record_M PM where " & trim(cmbBy.selecteditem.value) & " like '%" & trim(txtSearch.text) & "%' and app1_by is not null order by seq_no desc"
        IF StrSql <> "" THEN
    ...
    Sub ShowPalletRecord(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("PalletRecordApp2Det.aspx?ID=" & SeqNo.text)
    End sub
    ...
    Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            if App2Date.text = "" then e.Item.CssClass = "PartSource"
        End if
    End Sub
