...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        IF page.ispostback=false then
            ...
            Do while RsUPASM.read
                ...
                if isdbnull(RsUPASM("PURC_BY")) = false then lblApproveBy.text = trim(ucase(RsUPASM("PURC_BY"))) & " - " & format(RsUPASM("PURC_DATE"),"dd/MMM/yy")
                ...
                if isdbnull(RsUPASM("MGT_BY")) = false then lblMgtBy.text = trim(ucase(RsUPASM("MGT_BY"))) & " - " & format(RsUPASM("MGT_DATE"),"dd/MMM/yy")
    
    
                lblPurcRem.text = trim(RsUPASM("purc_rem").tostring)
                if rsUPASM("UPAS_STATus") <> "REJECTED" Then
                    lblACC1Rem.text = "-"
                    lblACC2Rem.text = "-"
                    lblMGTRem.text = "-"
                elseif rsUPASM("UPAS_STATus") = "REJECTED" Then
                ...
                if isdbnull(RsUPASM("PURC_BY")) = true then
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        response.redirect("UPAApp.aspx")
    End Sub
    
    Sub cmdApprove_Click(sender As Object, e As EventArgs)
        Response.redirect("UPAAppApprove.aspx?ID=" & Request.params("ID"))
    End Sub
    
    Sub cmdReject_Click(sender As Object, e As EventArgs)
        response.redirect("UPAAppReject.aspx?ID=" & Request.params("ID"))
    End Sub
    ...
    '    response.redirect("UPAAttachment.aspx?ID=" & request.params("ID"))
        response.redirect("UPAAttachment.aspx?ID=" & request.params("ID") & "&ReturnURL=UPAAppDet.aspx?ID=" & Request.params("ID") )
    End Sub
                                                ...
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: white; BORDER-BOTTOM-COLOR: white; BORDER-TOP-COLOR: white; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: white" width="80%" align="center" border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label2" runat="server" cssclass="LabelNormal">Prepared by / date</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver" rowspan="2">
                                                                    <asp:Label id="Label6" runat="server" cssclass="LabelNormal">Approved(Purchasing)</asp:Label></td>
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblApproveBy" runat="server" cssclass="OutputText" width="100%"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label id="lblPurcRem" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver" rowspan="2">
                                                                    <asp:Label id="Label7" runat="server" cssclass="LabelNormal">Accounts 1</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblAcc1By" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label id="lblACC1Rem" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver" rowspan="2">
                                                                    <asp:Label id="Label71" runat="server" cssclass="LabelNormal">Accounts 2</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblAcc2By" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label id="lblACC2Rem" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver" rowspan="2">
                                                                    <asp:Label id="Label8" runat="server" cssclass="LabelNormal">Approved(Mgt)</asp:Label></td>
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblMgtBy" runat="server" cssclass="OutputText" width="100%"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblMgtRem" runat="server" cssclass="OutputText" width="100%"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
...
attachment.</asp:LinkButton>
                                                ...
                                                <p align="center">
                                                    <asp:DataList id="MyList" runat="server" Width="100%" OnSelectedIndexChanged="MyList_SelectedIndexChanged" OnItemCommand="ShowDetails" RepeatColumns="1" BorderWidth="0px" CellPadding="1" Height="101px" Font-Size="XX-Small" Font-Names="Arial">
