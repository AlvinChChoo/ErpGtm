...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
                 if page.ispostback = false then
                    ...
                    'if lblPCMCAppBy.text <> "" then cmdSubmit.visible = false
                    RsSO.Close()
                    rsRequest.close()
                    procLoadGridData()
                 end if
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td width="25%" bgcolor="silver">
                                                                Approval Remarks</td>
                                                            <td>
                                                                <asp:TextBox id="TextBox1" runat="server" Height="57px" Width="389px" CssClass="OutputText" TextMode="MultiLine"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <asp:DataGrid id="dtgPartList" runat="server" width="100%" Height="35px" BorderColor="Black" GridLines="Vertical" cellpadding="4" Font-Name="Verdana" AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="XX-Small" OnSortCommand="SortGrid" AllowSorting="True" OnItemDataBound="FormatRow" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PageSize="100">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Req Qty.">
                                                                ...
                                                                <ItemStyle horizontalalign="Right"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label id="ReqQty" cssclass="Outputtext" class="ErrorText" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Req_Qty") %>' /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
                                                ...
                                                <p align="center">
                                                    <asp:Label id="Label6" runat="server" width="100%" cssclass="Instruction">Are you
                                                    sure to approve this material request form ?</asp:Label>
                                                </p>
                                                <p>
                                                    <table style="HEIGHT: 18px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div align="right">
                                                                        <asp:Button id="cmdYes" onclick="cmdYes_Click" runat="server" Width="65px" Text="Yes"></asp:Button>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div align="left">&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                        <asp:Button id="cmdNo" onclick="cmdNo_Click" runat="server" Width="65px" Text="No" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
