...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Sub cmdBack_Click(sender As Object, e As EventArgs)
                response.redirect("MERFApp1.aspx")
            End Sub
    ...
    Sub cmdApproved_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            if rbApprove.checked = true then
                ReqCOM.ExecuteNonQuery("Update MERF_M set App1_By = '" & trim(request.cookies("U_ID").value) & "',App1_Date = '" & now & "',App1_Status = 'Y',App1_Rem = '" & replace(trim(txtRem.text),"'","`") & "' where MERF_NO = '" & trim(lblMRFNo.text) & "'")
            elseif rbReject.checked = true then
                ReqCOM.ExecuteNonQuery("Update MERF_M set App1_By = '" & trim(request.cookies("U_ID").value) & "',App1_Date = '" & now & "',App1_Status = 'N',App1_Rem = '" & replace(trim(txtRem.text),"'","`") & "',MERF_Status = 'REJECTED' where MERF_NO = '" & trim(lblMRFNo.text) & "'")
            end if
    
            ShowAlert("Selected MERF has been submitted.")
            redirectPage("MERFApp1Det.aspx?ID=" & Request.params("ID"))
        End if
    End Sub
                                            ...
                                            <td>
                                                ...
                                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtSubmitRem" runat="server" Width="499px" CssClass="OutputText" Height="63px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td bgcolor="silver">
