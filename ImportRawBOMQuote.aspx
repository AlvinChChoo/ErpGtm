...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.ispostback = false then Dissql("Select BOM_Quote_No from BOM_Quote_M where Import_model_no is null and Import_File_Name is null","BOM_Quote_No","BOM_Quote_No",cmbBOMQuoteNo)
    End Sub
    ...
    Sub ImportTextData()
        ...
        try
            ...
            While oRead.Peek <> -1
                ...
                if i = 15 then QuoteRem = trim(Str)
            next i
                ...
                ReqCOM.ExecuteNonQuery("Insert into Import_BOM_Quote(Bom_Quote_No,Main_Part,Part_No,Cust_Part_No,Part_Desc,Part_Spec,Ven_Code,Ven_Name,MFG_MPN,Curr_Code,P_Usage,UP,Lead_Time,SPQ,MOQ,Rem) Select '" & trim(cmbBOMQuoteNo.selecteditem.value) & "','" & trim(MainPart) & "','" & trim(PartNo) & "','" & trim(CustPartNo) & "','" & trim(PartDesc) & "','" & trim(PartSpec) & "','" & trim(VenCode) & "','" & trim(VenName) & "','" & trim(MFGMPN) & "','" & trim(CurrCode) & "'," & trim(PUsage) & "," & cdec(UP) & "," & trim(LeadTime) & "," & trim(SPQ) & "," & trim(MOQ) & ",'" & trim(QuoteRem) & "';")
            End While
            ...
            RemoveDuplicateItem
            oRead.Close()
            Response.redirect("ImportRawBOMQuote1.aspx?BOMQuoteNo=" & Trim(cmbBOMQuoteNo.selecteditem.value) & "&FileName=" & trim(FileControl.PostedFile.FileName))
            ...
            <table style="HEIGHT: 15px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label2" runat="server" width="100%" cssclass="FormDesc">BOM Quote Import</asp:Label>
                            </p>
                            <p>
                                <table style="HEIGHT: 20px" cellspacing="0" cellpadding="0" width="96%" align="center">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    <asp:CustomValidator id="CustomValidator1" runat="server" Display="Dynamic" OnServerValidate="ValPicFormat" ForeColor=" " EnableClientScript="False" ControlToValidate="" ErrorMessage="Quotation File can only be in Comma Delimited(.csv) format" CssClass="ErrorText" Width="100%"></asp:CustomValidator>
                                                </p>
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 80%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <p align="left">
                                                                        <asp:DropDownList id="cmbBOMQuoteNo" runat="server" CssClass="OutputText" Width="258px"></asp:DropDownList>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <div align="center">
                                                                        <asp:Button id="cmdImportTransData" onclick="cmdImportTransData_Click" runat="server" CssClass="OutputText" Width="99px" Text="GO"></asp:Button>
                                                                        &nbsp;<asp:Button id="Button1" onclick="Button1_Click" runat="server" Text="Button" Visible="False"></asp:Button>
                                                                        &nbsp;<asp:Button id="cmdHelp" onclick="cmdHelp_Click" runat="server" CssClass="OutputText" Width="99px" Text="Help File" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
