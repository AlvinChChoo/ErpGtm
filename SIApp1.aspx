    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
         ...
         Sub ProcLoadGridData()
             ...
             if cmbSearch.selecteditem.value = "REF_NO" then
                 StrSql = "Select * from VENDOR_INFO where REF_NO like '%" & trim(txtSearch.text) & "%' and submit_date is not null order by seq_no desc"
             elseif cmbSearch.selecteditem.value = "COMPANY_NAME" then
                 StrSql = "Select * from VENDOR_INFO where COMPANY_NAME like '%" & trim(txtSearch.text) & "%' and submit_date is not null order by seq_no desc"
             end if
         ...
         Sub ShowData(sender as Object,e as DataGridCommandEventArgs)
             ...
             Response.redirect("SIApp1Det.aspx?ID=" & SeqNo)
         End sub
        ...
        <p>
            <table style="HEIGHT: 5px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div align="center"><asp:Label id="Label1" runat="server" width="100%" cssclass="FormDesc">SUPPLIER
                                        ...
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    ...
                                                    <asp:TextBox id="txtSearch" runat="server" CssClass="OutputText" Height="19px" Width="164px"></asp:TextBox>
                                                    &nbsp;&nbsp;&nbsp;&nbsp; <asp:Label id="Label2" runat="server" cssclass="OutputText">BY</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:DropDownList id="cmbSearch" runat="server" CssClass="OutputText" Height="19px" Width="238px">
