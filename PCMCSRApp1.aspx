    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
             ...
             if page.isPostBack = false then
                 if request.cookies("U_ID") is nothing then
                     ...
                     ProcLoadGridData("SELECT * FROM SR_M where submit_date is not null order by seq_no desc")
                 end if
             else
                 if request.cookies("U_ID") is nothing then
                     response.redirect("AccessDenied.aspx")
                        ...
                        <td>
                            ...
                            <div align="center">
                                <asp:DataGrid id="GridControl1" runat="server" width="90%" OnItemDataBound="FormatRow" Font-Names="Verdana" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PagerStyle-HorizontalAligh="Right" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" PageSize="20" OnPageIndexChanged="OurPager" AllowPaging="True" BorderColor="Black" GridLines="Vertical" cellpadding="2" Font-Name="Verdana" Font-Size="XX-Small" ShowFooter="True" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="PCMCSRApp1Det.aspx?ID={0}" DataTextField="SR_NO" HeaderText="SR No"></asp:HyperLinkColumn>
