...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
                 cmdAddNew.attributes.add("onClick","javascript:if(confirm('This will create a new Supplier document.\nAre you sure to continue ?')==false) return false;")
         ...
         Sub cmdAddNew_Click(sender As Object, e As EventArgs)
             ...
             Dim RefNo as string = ReqCOM.GetDocumentNo("Ven_Info")
    
             ReqCOM.ExeCuteNonQuery("Insert into Vendor_Info(Ref_No,TRANS_DATE,Submit_By) SELECT '" & TRIM(RefNo) & "','" & NOW & "','" & request.cookies("U_ID").value & "';")
             reqcom.executeNonQuery("Update main set Ven_Info = Ven_Info + 1")
             response.redirect("SupplierSurveyFormDet.aspx?ID=" & ReqCOM.GetFieldVal("select seq_no from Vendor_Info where Ref_No = '" & trim(refNo) & "';","Seq_No"))
         End Sub
         ...
         Sub ShowData(sender as Object,e as DataGridCommandEventArgs)
             ...
             Response.redirect("SupplierSurveyFormDet.aspx?ID=" & SeqNo)
         End sub
                                                    ...
                                                    <table style="HEIGHT: 13px" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:Button id="cmdAddNew" onclick="cmdAddNew_Click" runat="server" Width="177px" Text="Add New"></asp:Button>
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                    <div align="right">
