...
our $c=
{
 ...
 temp_dir        => '/home/cgi-bin/UPLOAD1/temp',

 # Directory for uploaded files
 target_dir      => '/home/cgi-bin/uploads',

 # Path to the template using for upload status window
 templates_dir   => '/home/cgi-bin/Templates',
