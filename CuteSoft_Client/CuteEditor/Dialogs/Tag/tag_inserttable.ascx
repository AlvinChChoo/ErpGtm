...
<br />
<table width="380" cellpadding="1" cellspacing="0" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);"
	onclick="selectTemplates()" id="richDropDown" style="border:1px solid #ffffff;height:30;">
	<tr>
		<td style="padding-left:20px; background-color:white">
			<img src="Load.ashx?type=image&file=h-f-3Columns-Body.gif" alt="[[Table layout]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			[[Table layout]]
		</td>
...
<div id="list_Templates" style="display:none;">
	<div style="position:absolute; top:0; left:0; overflow:scroll; overflow-x:hidden;width:380; height:220; border-bottom:0px solid black;">
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(1)"><img src="Load.ashx?type=image&file=One-Column-Table.gif" alt="[[1ColumnTable]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				[[1ColumnTable]]</span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=yellowgreen, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(2)"><img src="Load.ashx?type=image&file=Two-Column-Table.gif" alt="[[2ColumnTable]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				[[2ColumnTable]]</span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=gold, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(3)"><img src="Load.ashx?type=image&file=Three-Column-Table.gif" alt="[[3ColumnTable]]"
					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[3ColumnTable]]</span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=violet, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(4)"><img src="Load.ashx?type=image&file=h-R-t-Body.gif" alt="[[Header-Right-TopLeft-Body]]"
					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[Header-Right-TopLeft-Body]]</span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(5)"><img src="Load.ashx?type=image&file=h-l-tr-Body.gif" alt="[[Header-Left-TopRight-Body]]"
					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[Header-Left-TopRight-Body]]</span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px;  cursor:hand; border-top:0px solid black;">
			<span onclick="parent.selectTemplate(6)"><img src="Load.ashx?type=image&file=h-f-3Columns-Body.gif" alt="[[Header-Footer-3-Columns]]"
		...
		<tr>
			...
			<td>
				<div style="border:1px solid gray;padding:1px;OVERFLOW: auto; HEIGHT: 215px; HEIGHT: 215px; ">
					<table id="tabledesign" border="1" cellspacing="" style='border-color:#FFA500;background-color:white;width:210px;height:210px;border-collapse:collapse' class="normal">
					</table>
				</div>
			</td>
			<td align="center">
