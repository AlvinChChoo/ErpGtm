				...
				<tr>
					...
					<td valign="top" style="white-space:nowrap;padding:0 5px 3px 8px;" >
						<table cellpadding="0" cellspacing="0" style="padding-bottom:10">
							<tr>
								<td>[[Bordercolor]]:<br />
									<input autocomplete="off" type="text" id="bordercolor" name="bordercolor" size="7" style="WIDTH:57px" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="bordercolor.value=this.selectedColor; bordercolor_Preview.style.backgroundColor=bordercolor.style.backgroundColor=this.selectedColor" />
									<img alt="" id="bordercolor_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="bordercolor.value=this.selectedColor; bordercolor_Preview.style.backgroundColor=bordercolor.style.backgroundColor=this.selectedColor" align="absmiddle" />
								</td>
							</tr>
							<tr>
								<td>[[ForeColor]]:<br />
									<input autocomplete="off" type="text" id="inp_color" name="inp_color" size="7" style="WIDTH:57px" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_color.value=this.selectedColor; inp_color_Preview.style.backgroundColor=inp_color.style.backgroundColor=this.selectedColor" > 
									<img alt="" id="inp_color_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_color.value=this.selectedColor; inp_color_Preview.style.backgroundColor=inp_color.style.backgroundColor=this.selectedColor" align="absmiddle" />
								</td>
							</tr>
							<tr>
								<td>[[Shade]]:<br />
									<input autocomplete="off" type="text" id="inp_shade" name="inp_shade" size="7" style="WIDTH:57px" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_shade.value=this.selectedColor; inp_shade_Preview.style.backgroundColor=inp_shade.style.backgroundColor=this.selectedColor" > 
								    <img alt="" id="inp_shade_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_shade.value=this.selectedColor; inp_shade_Preview.style.backgroundColor=inp_shade.style.backgroundColor=this.selectedColor" align="absmiddle" />
								</td>
							</tr>
						</table>
					</td>
