...
<fieldset>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			<td>[[Color]]</td>
			<td>
				<input autocomplete="off" size="8" type="text" id="inp_color" oncolorpopup="this.selectedColor=value" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange='inp_color.value=this.selectedColor; inp_color.style.backgroundColor=this.selectedColor' />
			</td>
		</tr>
	</table>
</fieldset>
