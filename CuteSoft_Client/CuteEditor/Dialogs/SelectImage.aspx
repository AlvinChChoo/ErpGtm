...
<% if(secset.AllowModify) {%>
	<img id="img_ImageEditor" class="dialogButton" src="Load.ashx?type=image&file=imageeditor.gif" onclick="ImageEditor();" alt="[[ImageEditor]]" />
<%
}
else
{
%>
	<img id="img_ImageEditor" class="CuteEditorButtonDisabled" src="Load.ashx?type=image&file=imageeditor.gif" alt="[[ImageEditor]]" />
<%
}
%>
					</td>
...
<img id="img_demo" src="../Load.ashx?type=image&file=1x1.gif" alt="" />
							</div>
						</div>
					</td>
				</tr>
