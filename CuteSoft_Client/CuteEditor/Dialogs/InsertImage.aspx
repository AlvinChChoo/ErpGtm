...
<img id="btn_bestfit" src="../Load.ashx?type=image&file=bestfit.gif" onclick="BestFit();" alt="[[BestFit]]" class="dialogButton" />
...
<% if(secset.AllowModify) {%>
	<img class="dialogButton" id="img_ImageEditor" src="../Load.ashx?type=image&file=imageeditor.gif" onclick="ImageEditor();" alt="[[ImageEditor]]" />
<%
}
else
{
%>
	<img class="CuteEditorButtonDisabled" id="img_ImageEditor" src="../Load.ashx?type=image&file=imageeditor.gif" alt="[[ImageEditor]]" />
<%
}
%>
					</td>
...
<input type="text" size="2" name="Border" onchange="do_preview()" onpropertychange="do_preview()" onkeypress="return CancelEventIfNotDigit()" style="WIDTH : 80px" id="Border" />
								...
								<tr>
									<td>[[Bordercolor]]:</td>
									<td style="text-align:left">
<input type="text" id="bordercolor" name="bordercolor" size="7" style='WIDTH:57px;behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' />
<img alt="[[Preview]]" src="../Load.ashx?type=image&file=colorpicker.gif" id="bordercolor_Preview" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc); vertical-align:inherit' />
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<table border="0" cellpadding="0" cellspacing="0" class="normal">
											<tr>
												...
												<td rowspan="2" align="right" valign="middle">
												    <img src="../Load.ashx?type=image&file=locked.gif" id="imgLock" width="25" height="32"	alt="[[ConstrainProportions]]" />
												</td>
											</tr>
											<tr>
												<td>[[Height]]:</td>
