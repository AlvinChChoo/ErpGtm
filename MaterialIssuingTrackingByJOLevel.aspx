...
<script runat="server">
    ...
    Sub cmdGO_Click(sender As Object, e As EventArgs)
        ...
        redirectPage("MaterialIssuingTrackingByJOLevel.aspx")
    End Sub
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" marginheight="0" marginwidth="0" onkeypress="KeyPress()">
    <form runat="server">
        <p>
                                                    ...
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList id="cmbLevel" runat="server" Width="254px" CssClass="OutputText" OnSelectedIndexChanged="cmbLevel_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
