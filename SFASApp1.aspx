...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Sub ProcLoadGridData
            Dim StrSql as string = "select app1_by,app1_date,app2_by,app2_date,sfas_status,submit_by,submit_date,seq_no,SFAS_NO from SFAS_M where Submit_Date is not null"
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <div align="center">
                                <asp:DataGrid id="GridControl1" runat="server" width="90%" AutoGenerateColumns="False" ShowFooter="True" Font-Size="XX-Small" Font-Name="Verdana" cellpadding="2" GridLines="Vertical" BorderColor="Black" AllowPaging="True" PageSize="20" PagerStyle-NextPageText="Next" PagerStyle-PrevPageText="Prev" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" Font-Names="Verdana" OnItemDataBound="FormatRow" OnPageIndexChanged="OurPager">
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="SFASApp1Det.aspx?ID={0}" DataTextField="SFAS_No" HeaderText="SFAS #"></asp:HyperLinkColumn>
