    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
             if page.isPostBack = false then
                 if request.cookies("U_ID") is nothing then
                     ...
                     ProcLoadGridData("SELECT * FROM SR_M where App2_date is not null order by seq_no desc")
                 end if
             else
                 if request.cookies("U_ID") is nothing then
                     response.redirect("AccessDenied.aspx")
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <div align="center">&nbsp;<asp:DataGrid id="GridControl1" runat="server" width="90%" AutoGenerateColumns="False" ShowFooter="True" Font-Size="XX-Small" Font-Name="Verdana" cellpadding="2" GridLines="Vertical" BorderColor="Black" AllowPaging="True" OnPageIndexChanged="OurPager" PageSize="20" PagerStyle-NextPageText="Next" PagerStyle-PrevPageText="Prev" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" Font-Names="Verdana" OnItemDataBound="FormatRow">
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="PCMCSRApp3Det.aspx?ID={0}" DataTextField="SR_NO" HeaderText="SR No"></asp:HyperLinkColumn>
