...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select SM.Model_No,MM.MERF_NO,MM.JO_No,MM.P_Level,MM.Submit_By,MM.Submit_Date,MM.App1_By,MM.App2_By,MM.App3_By,MM.App1_Date,MM.App2_Date,MM.App3_Date,MM.MERF_Status,JM.Lot_No from merf_m MM,Job_Order_M JM,SO_Models_M SM where mm.jo_no = jm.jo_no and jm.lot_no = sm.lot_no and mm.App1_Date is not null order by MERF_No desc"
    ...
    Sub ShowMRF(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("MERFApp2Det.aspx?ID=" & SeqNo)
    End sub
