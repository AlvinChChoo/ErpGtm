...
<script runat="server">
    ...
    sub LoadData
        ...
        do while rsSupplier.read
                ...
                txtApp2Rem.text = rsSupplier("App2_Rem").tostring
                ...
                if isdbnull(rsSupplier("App2_Status")) = true then
                    rbApp2Approve.checked = true
                elseif rsSupplier("App2_Status") = "Y" then
                    rbApp2Approve.checked = true
                elseif rsSupplier("App2_Status") = "N" then
                    rbApp2Reject.checked = true
                end if
    
    
    
    
                if isdbnull(rsSupplier("App1_Date")) = false then lblApp1Date.text = format(cdate(rsSupplier("App1_Date").tostring),"dd/MMM/yyyy")
                if isdbnull(rsSupplier("App2_Date")) = false then lblApp2Date.text = format(cdate(rsSupplier("App2_Date").tostring),"dd/MMM/yyyy")
                if isdbnull(rsSupplier("App3_Date")) = false then lblApp3Date.text = format(cdate(rsSupplier("App3_Date").tostring),"dd/MMM/yyyy")
    
                if isdbnull(rsSupplier("App2_date")) = false then
    ...
    Sub cmdApprove_Click(sender As Object, e As EventArgs)
        ...
        Dim ReqCOm as ERP_GTM.ERP_GTM = new ERP_GTM.ERP_GTM
        ReqCOm.ExecuteNonQuery("Update Vendor_Info set APP2_By = '" & trim(request.cookies("U_ID").value) & "',App2_Date = '" & now & "',APP2_Status = 'Y',App2_Rem = '" & trim(txtApp2Rem.text) & "' where Seq_No = " & Request.params("ID") & ";")
    
        ShowAlert ("Supplier Information Approved.")
        redirectPage("SIApp2Det.aspx?ID=" & Request.params("ID"))
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p align="center">
                                <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" CssClass="Outputtext" Width="100%" EnableClientScript="False" ControlToValidate="txtApp2Rem" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Remarks."></asp:RequiredFieldValidator>
                            </p>
                            <p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <asp:Label id="lblCompanyName" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label id="lblAdd1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td width="20%" bgcolor="silver">
                                                <asp:Label id="Label11" runat="server" cssclass="LabelNormal">Main Shareholder</asp:Label></td>
                                            <td width="30%">
                                                <asp:Label id="lblMainShareholder" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblAdd2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label12" runat="server" cssclass="LabelNormal">Sales</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblSales" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblAdd3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label16" runat="server" cssclass="LabelNormal">Total Employees</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblTotalEmp" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label2" runat="server" cssclass="LabelNormal">Tel No</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblTel" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label18" runat="server" cssclass="LabelNormal">Type of Ownership</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblTypeOfOwner" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label3" runat="server" cssclass="LabelNormal">Fax No</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblFax" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label8" runat="server" cssclass="LabelNormal">Authorised Capital</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAuthorisedCap" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                            ...
                                            <td>
                                                <asp:Label id="lblPaidUpCap" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label6" runat="server" cssclass="LabelNormal">E-Mail(for P/O) </asp:Label></td>
                                            <td>
                                                <asp:Label id="lblEMailPO" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label14" runat="server" cssclass="LabelNormal">Spare %</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblSparePctg" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label13" runat="server" cssclass="LabelNormal">E-Mail(for part Approval)</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblEMailSSER" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label15" runat="server" cssclass="LabelNormal">Place of Departure</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPlaceOfDeparture" runat="server" cssclass="lblPlaceOfDeparture" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label33" runat="server" cssclass="LabelNormal">Registration No</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblRegNo" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label34" runat="server" cssclass="LabelNormal">Formation Year</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblFormationYear" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <asp:Label id="lblTypeOfBiz1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td width="50%" bgcolor="silver" colspan="3">
                                                <asp:Label id="Label22" runat="server" cssclass="LabelNormal">Major Customers :</asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblTypeOfBiz2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label id="lblTypeOfBiz3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblMajorCust1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualSales1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPctgOfTotal1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver" rowspan="3">
                                                <asp:Label id="Label27" runat="server" cssclass="LabelNormal">Last 3 month Turn Over</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblTurnOver1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblMajorCust2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualSales2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPctgOfTotal2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblTurnOver2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblMajorCust3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualSales3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPctgOfTotal3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblTurnOver3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblMajorCust4" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualSales4" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPctgOfTotal4" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label31" runat="server" cssclass="LabelNormal">Annual Turnover </asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualTurnover" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblMajorCust5" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblAnnualSales5" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblPctgOfTotal5" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <asp:Label id="lblProductType1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td width="20%" bgcolor="silver" rowspan="3">
                                                <asp:Label id="Label32" runat="server" cssclass="LabelNormal">Monthly Production Capacity</asp:Label></td>
                                            <td width="30%">
                                                <asp:Label id="lblProductionCapacity1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblProductType2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblProductionCapacity2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label id="lblProductType3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblProductionCapacity3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label id="lblDelMode" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td width="20%" bgcolor="silver">
                                                <asp:Label id="Label40" runat="server" cssclass="LabelNormal">Name</asp:Label></td>
                                            <td width="30%">
                                                <asp:Label id="lblBankerName" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                            ...
                                            <td>
                                                <asp:Label id="lblBankerAdd1" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label29" runat="server" cssclass="LabelNormal">Currency</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblCurr" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                            <td>
                                                <asp:Label id="lblBankerAdd2" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" rowspan="2">
                                            </td>
                                            <td>
                                                <asp:Label id="lblBankerAdd3" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="silver">
                                                <asp:Label id="Label28" runat="server" cssclass="LabelNormal">Account No</asp:Label></td>
                                            <td>
                                                <asp:Label id="lblBankerACNo" runat="server" cssclass="OutputText" width="100%"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label id="lblSubmitRem" runat="server" cssclass="LabelNormal" width="100%"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                                ...
                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox id="txtApp2Rem" runat="server" CssClass="outputText" Width="100%" MaxLength="400" Height="54px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:RadioButton id="rbApp2Approve" runat="server" CssClass="outputText" Width="100%" Text="Approved" GroupName="App2"></asp:RadioButton>
                                                <asp:RadioButton id="rbApp2Reject" runat="server" CssClass="outputText" Width="100%" Text="Rejected" GroupName="App2"></asp:RadioButton>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <p>
                                <table style="HEIGHT: 9px" width="100%">
                                    <tbody>
                                        <tr>
                                            <td width="33%">
                                                <asp:Button id="cmdApprove" onclick="cmdApprove_Click" runat="server" Width="104px" Text="Approve"></asp:Button>
                                            </td>
                                            <td width="33%">
                                                <div align="center">
