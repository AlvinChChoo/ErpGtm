...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
             if page.ispostback = false then
                 ...
                 if trim(Request.params("MainPartB4")) <> "-" then
                     ...
                     Do while rs1.read
                        ...
                        if trim(rs1("Ref_Supp_Purc").tostring) = trim(rs1("Ref_Supp_Code_Purc").tostring) then dissql("Select Ref_Supp_Code_Purc,Ref_Supp_Purc from part_master where seq_no = " & request.params("ID") & ";","Ref_Supp_Code_Purc","Ref_Supp_Purc",cmbSearchVen)
                        ...
                        Dissql("Select ref_supp_code_purc,ref_supp_purc from part_master where Seq_No = " & clng(request.params("ID")) & "","ref_supp_code_purc","ref_supp_purc",cmbSearchVen)
         ...
         Sub cmdUpdate_Click(sender As Object, e As EventArgs)
             if page.isvalid = true then
                ...
                elseif Cdec(StdCost) <> 0 then
                    ...
                    ShowAlert("Std. Cost Updated.")
                    redirectPage("PopupBOMQuoteStdCost.aspx?ID=" & Request.params("ID"))
                end if
             end if
         End Sub
        ...
        Sub UpdateLastQuote()
            ...
            Dim drGetFieldVal As SqlDataReader = myCommand.ExecuteReader(CommandBehavior.CloseConnection)
            do while drGetFieldVal.read
                lblLastQuoteUP.text = drGetFieldVal("std_up").tostring
                lblLastQuoteCurr.text = drGetFieldVal("std_curr_code").tostring
                lblLastQuoteOriUP.text = drGetFieldVal("Std_ori_up").tostring
                lblLastQuoteLT.text = drGetFieldVal("Std_LT").tostring
                lblLastQuoteSPQ.text = drGetFieldVal("STD_SPQ").tostring
                lblLastQuoteMOQ.text = drGetFieldVal("std_MOQ").tostring
                lblLastQuoteVenName.text = drGetFieldVal("std_Ven_Name").tostring
                                ...
                                <table style="HEIGHT: 71px" width="98%" align="center">
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <p align="center">
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" EnableClientScript="False" ControlToValidate="txtOriStdCostPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Std Cost." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" EnableClientScript="False" ControlToValidate="txtSPQPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid SPQ." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator7" runat="server" EnableClientScript="False" ControlToValidate="txtUOMPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Unit." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" EnableClientScript="False" ControlToValidate="txtMOQPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid MOQ." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server" EnableClientScript="False" ControlToValidate="txtRawMatPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Raw Material." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server" EnableClientScript="False" ControlToValidate="txtRawMatCostPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Raw Material Cost." Width="100%" CssClass="ErrorText"></asp:RequiredFieldValidator>
                                                    <asp:CompareValidator id="CompareValidator1" runat="server" EnableClientScript="False" ControlToValidate="txtMOQPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid MOQ." Width="100%" CssClass="ErrorText" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator2" runat="server" EnableClientScript="False" ControlToValidate="txtSPQPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid SPQ." Width="100%" CssClass="ErrorText" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator3" runat="server" EnableClientScript="False" ControlToValidate="txtOriStdCostPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Std. Cost" Width="100%" CssClass="ErrorText" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator4" runat="server" EnableClientScript="False" ControlToValidate="txtRawMatCostPurc" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Raw Material Cost." Width="100%" CssClass="ErrorText" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                                </p>
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <div align="center"><asp:Label id="Label10" runat="server" width="100%" cssclass="FormDesc">Part
                                                                        Details </asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="75%">
                                                                    <div align="left"><asp:Label id="lblPartNo" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblPartDesc" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblPartSpec" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <div align="center"><asp:Label id="Label12" runat="server" width="100%" cssclass="FormDesc">R
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="75%">
                                                                    <div align="left">
                                                                        <div align="left"><asp:Label id="lblCurrCodeRD" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left">
                                                                        <div align="left"><asp:Label id="lblOriStdCostRD" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblStdCostRD" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label id="lblRefSuppRD" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label9" runat="server" cssclass="LabelNormal">Raw Material Description</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblRawMatRD" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label id="lblSPQRD" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label7" runat="server" cssclass="LabelNormal">MOQ.</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblMOQRD" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label26" runat="server" cssclass="LabelNormal">Lead Time (wks)</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblLeadTimeRD" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </p>
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <div align="center"><asp:Label id="Label15" runat="server" width="100%" cssclass="FormDesc">Purchasing
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="75%">
                                                                    <div align="left">
                                                                        <asp:DropDownList id="cmbCurrCodePurc" runat="server" Width="184px" CssClass="OutputText"></asp:DropDownList>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left">
                                                                        <div align="left">
                                                                            <asp:TextBox id="txtOriStdCostPurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                            &nbsp; 
                                                                            <asp:Button id="cmdCalculatePurc" onclick="cmdCalculatePurc_Click" runat="server" Width="89px" CssClass="OutputText" CausesValidation="False" Text="Calculate"></asp:Button>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblStdCostPurc" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtSearchVen" onkeydown="KeyDownHandler(cmdSearchVen)" onclick="GetFocus(txtSearchVen)" runat="server" Width="78px" CssClass="OutputText">-- Search --</asp:TextBox>
                                                                    ...
                                                                    &nbsp; 
                                                                    <asp:DropDownList id="cmbSearchVen" runat="server" Width="403px" CssClass="OutputText" autopostback="True" OnSelectedIndexChanged="cmbPartNo_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtRawMatPurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtRawMatCostPurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                    &nbsp;<asp:Label id="Label27" runat="server" cssclass="OutputText">per</asp:Label>&nbsp;<asp:TextBox id="txtUOMPurc" runat="server" Width="79px" CssClass="OutputText"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtSPQPurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtMOQPurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox id="txtLeadTimePurc" runat="server" Width="184px" CssClass="OutputText"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
