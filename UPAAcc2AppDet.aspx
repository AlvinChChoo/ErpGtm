...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        IF page.ispostback=false then
            ...
            Do while RsUPASM.read
                ...
                if isdbnull(RsUPASM("ACC2_BY")) = false
                    cmdREject.enabled = false
                    cmdapprove.enabled = false
                elseif isdbnull(RsUPASM("ACC2_BY")) = true
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        response.redirect("UPAAcc2App.aspx")
    End Sub

    Sub cmdApprove_Click(sender As Object, e As EventArgs)
        response.redirect("UPAAcc2Approve.aspx?ID=" & Request.params("ID"))
    End Sub

    Sub cmdReject_Click(sender As Object, e As EventArgs)
        response.redirect("UPAAcc2Reject.aspx?ID=" & Request.params("ID"))
    End Sub
    ...
    Sub FormatRow()
        Dim i As Integer
        Dim ReqCOM as ERP_GTM.ERP_GTM = new ERP_GTM.ERP_GTM
        Dim Validity,DiffAmt,DiffPctg,WACCost,SeqNo As Label
                                                ...
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: white; BORDER-BOTTOM-COLOR: white; BORDER-TOP-COLOR: white; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: white" width="80%" align="center" border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label1" runat="server" width="128px" cssclass="LabelNormal">Remarks</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label2" runat="server" width="128px" cssclass="LabelNormal">Prepared
                                                                    By</asp:Label></td>
                                                                <td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <ItemTemplate>
                                                                                                    ...
                                                                                                    <asp:LinkButton id="Edit" CommandArgument='BOMCost' runat="server" Font-Size="X-Small" ForeColor="Red" Font-Bold="True">BOM Cost</asp:LinkButton>
                                                                                                </ItemTemplate>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
