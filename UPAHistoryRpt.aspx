...
<script runat="server">
    ...
    Sub cmdViewByPart_Click(sender As Object, e As EventArgs)
        if (txtPartNoFrom.text = "" and txtPartNoTo.text = "") then
            ShowAlert("You don seem to have supplied a valid part No range.")
            Exit sub
        end if
    
        if txtPartNoFrom.text = "" then txtPartNofrom.text = txtPartNoto.text
        if txtPartNoTo.text = "" then txtPartNoTo.text = txtPartNoFrom.text
        ShowReport("PopupReportViewer.aspx?RptName=UPAHistory&PartNoFrom=" & trim(txtPartNoFrom.text) & "&PartNoTo=" & trim(txtPartNoTo.text & "&Status=" & cmbStatusPart.selecteditem.value & "&RptType=Part"))
        redirectPage("UPAHistoryRpt.aspx")
    End Sub
    ...
    Sub cmdViewBySupplier_Click(sender As Object, e As EventArgs)
        ShowReport("PopupReportViewer.aspx?RptName=UPAHistory&SupplierFrom=" & trim(cmbSupplierFrom.selecteditem.value) & "&RptType=Supplier&SupplierTo=" & trim(cmbSupplierTo.selecteditem.value & "&Status=" & cmbStatusSupplier.selecteditem.value))
        redirectPage("UPAHistoryRpt.aspx")
    End Sub
            ...
            <table style="HEIGHT: 38px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td colspan="3">
                            <p align="center">
                                <asp:Label id="Label2" runat="server" cssclass="FormDesc" width="100%" backcolor="" forecolor="">PARTS
                                UNIT PRICE APPROVAL HISTORY REPORT</asp:Label>
                            </p>
                            <p>
                                <table style="HEIGHT: 9px" cellspacing="0" cellpadding="0" width="70%" align="center">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>
                                                ...
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="3">
                                                                    <div align="center"><asp:Label id="Label4" runat="server" cssclass="FormDesc" width="100%">By
                                                                    ...
                                                                    <div align="center">
                                                                        <table style="HEIGHT: 31px" cellspacing="0" cellpadding="0" width="100%" border="1">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td bgcolor="silver">
                                                                                        <asp:Label id="Label8" runat="server">UPA Status</asp:Label></td>
                                                                                    <td>
                                                                                        <p align="center">
                                                                                            <asp:DropDownList id="cmbStatusPart" runat="server" Width="100%" CssClass="OutputText">
                                                ...
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="3">
                                                                    <div align="center"><asp:Label id="Label5" runat="server" cssclass="FormDesc" width="100%">By
                                                                    ...
                                                                    <div align="center">
                                                                        <table style="HEIGHT: 31px" cellspacing="0" cellpadding="0" width="100%" border="1">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td bgcolor="silver">
                                                                                        <asp:Label id="Label9" runat="server">Supplier To</asp:Label></td>
                                                                                    <td>
                                                                                        <p align="center">
                                                                                ...
                                                                                <tr>
                                                                                    <td bgcolor="silver">
                                                                                        <asp:Label id="Label7" runat="server">UPA Status</asp:Label></td>
                                                                                    <td>
                                                                                        <p align="center">
                                                                                            <asp:DropDownList id="cmbStatusSupplier" runat="server" Width="100%" CssClass="OutputText">
                                                                                                <asp:ListItem Value="APPROVED">APPROVED</asp:ListItem>
                                                                                                <asp:ListItem Value="PENDING APPROVAL">PENDING APPROVAL</asp:ListItem>
                                                                                                <asp:ListItem Value="PENDING SUBMISSION">PENDING SUBMISSION</asp:ListItem>
                                                                                                <asp:ListItem Value="REJECTED">REJECTED</asp:ListItem>
