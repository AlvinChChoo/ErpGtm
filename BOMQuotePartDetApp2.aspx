...
<script runat="server">
    ...
    Sub ShowMainPartDet()
        ...
        do while drGetFieldVal.read
            ...
            if isdbnull(drGetFieldVal("WAC_Date")) = false then lblWAC.text = format(cdate(drGetFieldVal("WAC_Date")),"dd/MM/yy")
        loop
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        Dim ReqCOM as ERP_GTM.ERP_GTM = new ERP_GTM.ERP_GTM
        Response.redirect("BOMQuoteDetApp2.aspx?ID=" & ReqCOM.GetFieldVal("Select Seq_No from bom_quote_m where bom_quote_no = '" & trim(lblBOMQuoteNo.text) & "';","Seq_No"))
    End Sub
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                ...
                                                <p align="center">
                                                    <asp:Label id="Label3" runat="server" width="100%" cssclass="SectionHeader">MAIN PART
                                                    DETAILS</asp:Label> 
                                                                        ...
                                                                        <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" align="center" border="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label id="lblBOMQuoteNo" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td bgcolor="silver">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div align="left"><asp:Label id="lblCustPartNo" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div align="left"><asp:Label id="lblMfgPartNo" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                ...
                                                <p align="center">
                                                    <asp:Label id="Label4" runat="server" width="100%" cssclass="SectionHeader">ALTERNATE
                                                    ...
                                                    <table class="sideboxnotop" style="HEIGHT: 9px" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:DataList id="MyList" runat="server" Height="101px" CellPadding="1" BorderWidth="0px" RepeatColumns="1" OnSelectedIndexChanged="MyList_SelectedIndexChanged" Width="100%">
                                                    ...
                                                    <table style="HEIGHT: 18px" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="right">
                                                                        <asp:Button id="cmdBack" onclick="cmdBack_Click" runat="server" Width="90px" Text="Back" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
