...
<html>
    <head>
		<title>ASP and ASP.NET WYSIWYG Editor - Create ASP.NET PDF </title>
			...
			<table>
				<tr>					
					...
					<td valign="top" width="750">
						...
						This example demonstrates you can use Cute Editor to create industry standard PDF files on the fly. In the following example, when you submit the form, the html code generated by the Editor is saved into a PDF file. <a href="document.PDF"><b>Check the PDF file</b></a>
						<br><br>
						<CE:Editor id="Editor1" URLType="Absolute" EditorWysiwygModeCss="../example.css" AutoConfigure="Simple" ThemeType="Office2003_BlueTheme" runat="server" ></CE:Editor><BR>
