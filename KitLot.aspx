...
<script runat="server">
    ...
    Sub ShowSO(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("KitLotDet.aspx?ID=" & SeqNo.text)
    End sub
    ...
    Sub cmdAddNew_Click(sender As Object, e As EventArgs)
        Response.redirect("KitLotAddNew.aspx")
    End Sub
                                                    ...
                                                    <table style="HEIGHT: 13px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td width="50%">
                                                                    <p>
                                                                        <asp:Button id="cmdAddNew" onclick="cmdAddNew_Click" runat="server" Text="New Kit Lot Form"></asp:Button>
                                                                    </p>
                                                                </td>
                                                                <td width="50%">
                                                                    <div align="right">
