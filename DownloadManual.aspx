...
<script runat="server">
    ...
    sub LoadProductDetails()
        ...
        lblFileName.text = ReqCOM.GetFieldVal("Select * from erp_manual where Seq_No = " & request.params("ID") & ";","File_Name")
        ...
        Response.WriteFile(Mappath("") + "\Manual\" + trim(lblFileName.text))
        Response.Flush()
        ...
        <table style="WIDTH: 424px; HEIGHT: 8px" cellspacing="0" cellpadding="0" width="424" align="center">
            <tbody>
                <tr>
                    <td>
                        <p>
                            <asp:Label id="lblFilePath1" runat="server" cssclass="OutputText" width="97px"></asp:Label><asp:Label id="lblFileName" runat="server" cssclass="OutputText" width="97px"></asp:Label><asp:Label id="lblFileExt1" runat="server" cssclass="OutputText" width="97px"></asp:Label>
                        </p>
                    </td>
                </tr>
            </tbody>
