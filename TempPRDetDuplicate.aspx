                                                ...
                                                <table style="HEIGHT: 18px" width="100%" align="center" border="1">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label id="lblPRNo" runat="server" width="373px" cssclass="OutputText"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label id="Label6" runat="server" width="77px" cssclass="LabelNormal">Buyer Code</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblBuyerCode" runat="server" width="373px" cssclass="OutputText"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label id="Label7" runat="server" width="77px" cssclass="LabelNormal">Buyer Name</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblBuyerName" runat="server" width="373px" cssclass="OutputText"></asp:Label></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <p>
                                                    <table style="HEIGHT: 25px" width="100%" border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:DataGrid id="dtgPartWithoutSource" runat="server" width="100%" OnItemDataBound="FormatNoSourceRow" Font-Size="XX-Small" Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="dtgPartWithoutSource_SelectedIndexChanged">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        &nbsp; <asp:Label id="Label12" runat="server" width="537px" cssclass="LabelNormal">to
                                                    ...
                                                    <table style="HEIGHT: 19px" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p align="center">
                                                                        <asp:Label id="Label8" runat="server" width="100%" cssclass="PartWithSourceLabel">Buyer
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:DataGrid id="dtgBuyerApprovedParts" runat="server" width="100%" OnItemDataBound="FormatBuyer" Font-Size="XX-Small" Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="dtgBuyerApprovedParts_SelectedIndexChanged" OnEditCommand="SplitVendor" AllowSorting="True" OnSortCommand="SortGrid">
                                                                            <FooterStyle cssclass="GridFooter"></FooterStyle>
                                                                            <AlternatingItemStyle cssclass="GridItemAlt"></AlternatingItemStyle>
                                                                            <ItemStyle cssclass="GridItem"></ItemStyle>
                                                                            <HeaderStyle bordercolor="White" cssclass="GridHeader"></HeaderStyle>
                                                    ...
                                                    <table style="HEIGHT: 15px" width="100%" border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:CustomValidator id="CheckQty" runat="server" Width="100%" EnableClientScript="False" CssClass="ErrorText" ErrorMessage="Please re-confirm the on hold qty for the highlighted item(s)." Display="Dynamic" ForeColor=" " OnServerValidate="ValQty"></asp:CustomValidator>
                                                                    </p>
                                                                    <p>
                                                                        <asp:DataGrid id="dtgPartWithSource" runat="server" width="100%" OnItemDataBound="FormatRow" Font-Size="XX-Small" Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="dtgPartWithSource_SelectedIndexChanged" OnEditCommand="SplitVendor" AllowSorting="True" OnSortCommand="SortGrid">
                                                                            <FooterStyle cssclass="GridFooter"></FooterStyle>
                                                                            <AlternatingItemStyle cssclass="GridItemAlt"></AlternatingItemStyle>
                                                                            <ItemStyle cssclass="GridItem"></ItemStyle>
                                                                            <HeaderStyle bordercolor="White" cssclass="GridHeader"></HeaderStyle>
