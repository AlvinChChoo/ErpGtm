    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
             if page.ispostback = false then
                 ...
                 if trim(Request.params("MainPartB4")) <> "-" then
                     ...
                     Do while rs1.read
                        ...
                        oList.Add(New ListItem(rs1("ref_supp_purc").tostring))
         ...
         Sub cmdUpdate_Click(sender As Object, e As EventArgs)
             if page.isvalid = true then
                ...
                lblStdCostPurc.text = format(cdec((txtOriStdCostPurc.text * Rate) / UnitConv),"##,##0.00000")
                ...
                elseif Cdec(StdCost) <> 0 then
                    if trim(cmbSearchVen.selecteditem.value) = trim(cmbSearchVen.selecteditem.text) then ReqCOM.ExecuteNonQuery("Update Part_Master set std_cost_purc = " & cdec(lblStdCostPurc.text) & ",ori_std_cost_purc = " & cdec(txtOriStdCostPurc.text) & ",std_cost_purc_curr_code = '" & trim(cmbCurrCodePurc.selecteditem.value) & "',SPQ_Purc = " & clng(txtSPQPurc.text) & ",moq_purc = " & clng(txtMOQPurc.text) & ",raw_mat_purc = '" & trim(txtRawMatPurc.text) & "',raw_mat_cost_purc = " & cdec(txtRawMatCostPurc.text) & ",Ref_Supp_Purc = '" & trim(cmbSearchVen.selecteditem.text) & "',Ref_Supp_Code_Purc = 'TempSupplier',uom_purc = '" & trim(txtUOMPurc.text) & "',Lead_Time_Purc = " & clng(txtLeadTimePurc.text) & ",purc_cost_by = '" & trim(request.cookies("U_ID").value) & "',purc_cost_date = '" & cdate(now) & "' where seq_no = " & request.params("ID") & ";")
                    if trim(cmbSearchVen.selecteditem.value) <> trim(cmbSearchVen.selecteditem.text) then ReqCOM.ExecuteNonQuery("Update Part_Master set std_cost_purc = " & cdec(lblStdCostPurc.text) & ",ori_std_cost_purc = " & cdec(txtOriStdCostPurc.text) & ",std_cost_purc_curr_code = '" & trim(cmbCurrCodePurc.selecteditem.value) & "',SPQ_Purc = " & clng(txtSPQPurc.text) & ",moq_purc = " & clng(txtMOQPurc.text) & ",raw_mat_purc = '" & trim(txtRawMatPurc.text) & "',raw_mat_cost_purc = " & cdec(txtRawMatCostPurc.text) & ",Ref_Supp_Purc = '" & trim(cmbSearchVen.selecteditem.text) & "',Ref_Supp_Code_Purc = '" & trim(cmbSearchVen.selecteditem.value) & "',uom_purc = '" & trim(txtUOMPurc.text) & "',Lead_Time_Purc = " & clng(txtLeadTimePurc.text) & ",purc_cost_by = '" & trim(request.cookies("U_ID").value) & "',purc_cost_date = '" & cdate(now) & "' where seq_no = " & request.params("ID") & ";")
                    ShowAlert("Std. Cost Updated.")
                    redirectPage("PopupPartStdCost.aspx?ID=" & Request.params("ID"))
                end if
             end if
                                ...
                                <table style="HEIGHT: 71px" width="98%" align="center">
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <p align="center">
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Std Cost." ForeColor=" " Display="Dynamic" ControlToValidate="txtOriStdCostPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid SPQ." ForeColor=" " Display="Dynamic" ControlToValidate="txtSPQPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator7" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Unit." ForeColor=" " Display="Dynamic" ControlToValidate="txtUOMPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid MOQ." ForeColor=" " Display="Dynamic" ControlToValidate="txtMOQPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Raw Material." ForeColor=" " Display="Dynamic" ControlToValidate="txtRawMatPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Raw Material Cost." ForeColor=" " Display="Dynamic" ControlToValidate="txtRawMatCostPurc" EnableClientScript="False"></asp:RequiredFieldValidator>
                                                    <asp:CompareValidator id="CompareValidator1" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid MOQ." ForeColor=" " Display="Dynamic" ControlToValidate="txtMOQPurc" EnableClientScript="False" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator2" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid SPQ." ForeColor=" " Display="Dynamic" ControlToValidate="txtSPQPurc" EnableClientScript="False" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator3" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Std. Cost" ForeColor=" " Display="Dynamic" ControlToValidate="txtOriStdCostPurc" EnableClientScript="False" Type="Double" Operator="DataTypeCheck"></asp:CompareValidator>
                                                    <asp:CompareValidator id="CompareValidator4" runat="server" CssClass="ErrorText" Width="100%" ErrorMessage="You don't seem to have supplied a valid Raw Material Cost." ForeColor=" " Display="Dynamic" ControlToValidate="txtRawMatCostPurc" EnableClientScript="False" Type="Double" Operator="DataTypeCheck"></asp:CompareValidator>
                                                </p>
                                                <p>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    &nbsp; 
                                                                    <asp:DropDownList id="cmbSearchVen" runat="server" CssClass="OutputText" Width="438px" autopostback="True" OnSelectedIndexChanged="cmbPartNo_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
