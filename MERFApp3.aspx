...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select SM.Model_No,MM.MERF_NO,MM.JO_No,MM.P_Level,MM.Submit_By,MM.Submit_Date,MM.App1_By,MM.App2_By,MM.App3_By,MM.App1_Date,MM.App2_Date,MM.App3_Date,MM.MERF_Status,JM.Lot_No from merf_m MM,Job_Order_M JM,SO_Models_M SM where mm.jo_no = jm.jo_no and jm.lot_no = sm.lot_no and mm.App2_Date is not null order by MERF_No desc"
        Dim resExePagedDataSet as Dataset = ReqCOM.ExePagedDataSet(StrSql,"merf_m")
        dtgShortage.visible = true
        dtgShortage.DataSource=resExePagedDataSet.Tables("merf_m").DefaultView
    ...
    Sub ShowMRF(sender as Object,e as DataGridCommandEventArgs)
        Dim ReqCOM as ERP_GTM.ERP_GTM = new ERP_GTM.ERP_GTM
        Dim MRFNo As Label = CType(e.Item.FindControl("MERFNo"), Label)
        Dim SeqNo as integer = ReqCOM.GetFieldVal("Select Seq_No from merf_m where MERF_NO = '" & trim(MRFNo.text) & "';","Seq_No")
        Response.redirect("MERFApp3Det.aspx?ID=" & SeqNo)
    End sub
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                ...
                                REQUEST FORM</asp:Label>
                            </p>
                            <p align="center">
                                <asp:Label id="lblUserRole" runat="server" width="291px" visible="False"></asp:Label>
                            </p>
                            <p align="center">
                                <table style="HEIGHT: 17px" cellspacing="0" cellpadding="0" width="90%">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    <asp:DataGrid id="dtgShortage" runat="server" width="100%" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" Height="35px" PageSize="100" BorderColor="Black" GridLines="Vertical" cellpadding="4" AutoGenerateColumns="False" OnItemDataBound="FormatRow" OnSortCommand="SortGrid" AllowSorting="True" Font-Names="Verdana" Font-Name="Verdana" Font-Size="XX-Small" OnEditCommand="ShowMRF">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="MRF No">
                                                                <ItemTemplate>
                                                                    <asp:Label id="MERFNo" runat="server" align="right" columns="8" maxlength="6" text='<%# DataBinder.Eval(Container.DataItem, "MERF_NO") %>' /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Status">
                                                                <ItemTemplate>
                                                                    <asp:Label id="MERFStatus" runat="server" align="right" columns="8" maxlength="6" text='<%# DataBinder.Eval(Container.DataItem, "MERF_Status") %>' /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
                                                    ...
                                                    <table style="HEIGHT: 25px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="50%">
                                                                    <div align="right">
                                                                        <asp:Button id="cmdBack" onclick="cmdBack_Click" runat="server" Width="114px" Text="Back"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
