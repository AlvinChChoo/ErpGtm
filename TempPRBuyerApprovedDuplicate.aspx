                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p>
                                                                        <asp:DataGrid id="dtgPartWithoutSource" runat="server" width="100%" Font-Size="XX-Small" Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="dtgPartWithoutSource_SelectedIndexChanged">
                                                                    ...
                                                                    <p>
                                                                        <asp:Button id="cmdUpdateSource" onclick="cmdUpdateSource_Click" runat="server" Width="155px" Text="Update Source"></asp:Button>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <table style="HEIGHT: 20px" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:Label id="Label4" runat="server" width="100%" cssclass="PartWithSourceLabel">Part(s)
                                                                        submitted for approval.</asp:Label>
                                                                    </p>
                                                                    <p>
                                                                        <asp:DataGrid id="dtgPartsSubmitted" runat="server" width="100%" Font-Size="XX-Small" Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="dtgPartsSubmitted_SelectedIndexChanged" OnItemDataBound="FormatApproval">
                                                                            <FooterStyle cssclass="GridFooter"></FooterStyle>
                                                                            <AlternatingItemStyle cssclass="GridItemAlt"></AlternatingItemStyle>
                                                                            <ItemStyle cssclass="GridItem"></ItemStyle>
                                                                            <HeaderStyle bordercolor="White" cssclass="GridHeader"></HeaderStyle>
                                                    ...
                                                    <table style="HEIGHT: 20px" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:Label id="Label3" runat="server" width="100%" cssclass="PartWithSourceLabel">Part(s)
                                                                    ...
                                                                    <p align="left">
                                                                        <asp:Label id="Label7" runat="server" width="100%" cssclass="Legend">Highlighted items
                                                                        indicates parts with variances.</asp:Label>
                                                                    </p>
                                                                    <p align="right">
                                                                        <asp:Label id="Label6" runat="server" width="253px" cssclass="Instruction">Total Amt</asp:Label><asp:Label id="lblTotalAmt" runat="server" width="183px" cssclass="Instruction">0</asp:Label>
                                                                    </p>
                                                                    <p align="right">
                                                                        <asp:Label id="Label9" runat="server" width="256px" cssclass="Instruction">Total Var
                                                                        (Amount)</asp:Label><asp:Label id="lblTotalVar" runat="server" width="183px" cssclass="Instruction">0</asp:Label>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <table style="HEIGHT: 20px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p align="right">
                                                                        <asp:Button id="cndBack" onclick="cndBack_Click" runat="server" Width="137px" Text="Back"></asp:Button>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
