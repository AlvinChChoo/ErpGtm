...
<script runat="server">
    ...
    Sub LoadDataWithSource()
        ...
        StrSql = "Select s.create_By,s.create_date,s.app1_by,s.app1_date,s.app2_by,s.app2_date,s.app3_date,s.app3_by,s.app4_date,s.app4_by,S.scar_no,s.ven_code,s.mif_no,s.part_no,ven.ven_name from scar s,vendor ven where s.ven_code = ven.ven_code and app2_by is not null order by scar_no desc"
    ...
    Sub ShowSO(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("SCARApp3Det.aspx?ID=" & SeqNo)
    End sub
