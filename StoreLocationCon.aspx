                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p align="center">
                                <asp:Label id="Label2" runat="server" cssclass="Instruction">Selected Store Location
                                have been added</asp:Label>
                            </p>
                            <p align="center">
                                <asp:LinkButton id="LinkButton1" onclick="LinkButton1_Click" runat="server">Check for new Store Location</asp:LinkButton>
                            </p>
                        </td>
                    </tr>
                </tbody>
