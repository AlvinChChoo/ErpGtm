...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.ispostback = false then
            ...
            Dissql("Select Model_Code, Model_Code + ' (' + model_Desc + ')' as [Desc] from Model_Master where Model_Code in (Select distinct(Model_No) from MRP_D_Rpt) order by Model_Code asc","Model_Code","Desc",cmbModel)
    
            if cmbModel.selectedindex = 0 then procLoadGridData
        End if
    End Sub
    
    Sub ProcLoadGridData()
        Dim StrSql as string = "SELECT sum(PR.QTY) as [QTY],PR.PART_NO,PR.Lot_No,PR.Model_No,PM.PART_DESC + '|' + PM.PART_SPEC AS [PART_DESC] FROM MRP_D_rpt PR,PART_MASTER PM WHERE PR.Model_No = '" & TRIM(cmbModel.selecteditem.value) & "' AND PR.PART_NO = PM.PART_NO and " & trim(cmbBy.selecteditem.value) & " like '%" & trim(txtSearch.text) & "%' group by PR.PART_NO,PR.Lot_No,PR.Model_No,PM.Part_Desc,PM.Part_Spec,PM.Part_No"
                    ...
                    <tr>
                        <td>
                            <div align="center"><asp:Label id="Label3" runat="server" cssclass="FormDesc" width="100%">Material
                                Shortage List - View By Model</asp:Label> 
                                <table style="HEIGHT: 16px" bordercolor="gray" cellspacing="0" cellpadding="0" width="100%" bgcolor="silver" border="1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="34%">
                                                <p align="center">
                                                    <asp:LinkButton id="LinkButton2" onmouseover="popup('View shortage list by Lot No','yellow')" onclick="LinkButton2_Click" onmouseout="kill()" runat="server" Font-Bold="True" ForeColor="White" CausesValidation="False" Width="100%">VIEW BY LOT NO</asp:LinkButton>
                                                </p>
                                            </td>
                                            <td width="33%">
                                                <p align="center">
                                                    <asp:LinkButton id="LinkButton4" onmouseover="popup('View shortage list by Model','yellow')" onclick="LinkButton4_Click" onmouseout="kill()" runat="server" Font-Bold="True" ForeColor="White" CausesValidation="False" Width="100%" BackColor="#FF8080">VIEW BY MODEL</asp:LinkButton>
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                                    ...
                                                    <table style="HEIGHT: 12px" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p align="center">
                                                                        <asp:Label id="Label1" runat="server" cssclass="OutputText" width="">MODEL</asp:Label>&nbsp;&nbsp; 
                                                                        <asp:DropDownList id="cmbModel" runat="server" Width="207px" CssClass="OutputText"></asp:DropDownList>
