    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
             ...
             if page.isPostBack = false then
                 if request.cookies("U_ID") is nothing then
                     ...
                     ProcLoadGridData("SELECT * FROM Buyer_SR_M where app2_by is not null")
                 end if
             else
                 if request.cookies("U_ID") is nothing then
                     response.redirect("AccessDenied.aspx")
        ...
        Sub ProcLoadGridData(StrSql as string)
             ...
             Dim resExePagedDataSet as Dataset = ReqExePagedDataSet.ExePagedDataSet(StrSql,"Buyer_SR_M")
             GridControl1.DataSource=resExePagedDataSet.Tables("Buyer_SR_M").DefaultView
        ...
        Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
            If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
                ...
                if trim(SRStatus.text) <> "REJECTED" then
                    if trim(App3Date.text) = "" then e.Item.CssClass = "PartSource"
                end if
            end if
        End Sub
                        ...
                        <td>
                            ...
                            <div align="center">
                                <asp:DataGrid id="GridControl1" runat="server" width="90%" OnItemDataBound="FormatRow" Font-Names="Verdana" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PagerStyle-HorizontalAligh="Right" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" PageSize="20" OnPageIndexChanged="OurPager" AllowPaging="True" BorderColor="Black" GridLines="Vertical" cellpadding="2" Font-Name="Verdana" Font-Size="XX-Small" ShowFooter="True" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="BuyerSRApp3Det.aspx?ID={0}" DataTextField="SR_NO" HeaderText="SR No"></asp:HyperLinkColumn>
                                        ...
                                        <asp:TemplateColumn HeaderText="M.D.">
                                            <ItemTemplate>
