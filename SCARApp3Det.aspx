...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        if page.isPostBack = false then
            ...
            do while rs.read
                ...
                if isdbnull(rs("App3_By")) = true then
                    cmdSubmit.enabled = true
                elseif isdbnull(rs("App3_By")) = false then
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        response.redirect("SCARApp3.aspx")
    End Sub
    
    Sub cmdSubmit_Click(sender As Object, e As EventArgs)
        Dim ReqCOM as erp_gtm.erp_gtm = new erp_gtm.erp_gtm
        if rbSort.checked = true then ReqCOM.executeNonQuery("Update SCAR set App3_By = '" & trim(request.cookies("U_ID").value) & "',App3_Date = '" & cdate(now) & "',App3_Status = 'Y',PURC_DISPOSITION = 'SORT',PURC_OTHERS = '" & TRIM(replace(txtOthers.text,"'","`")) & "' where scar_no = '" & trim(lblScarNo.text) & "';")
        if rbRTV.checked = true then ReqCOM.executeNonQuery("Update SCAR set App3_By = '" & trim(request.cookies("U_ID").value) & "',App3_Date = '" & cdate(now) & "',App3_Status = 'Y',PURC_DISPOSITION = 'RTV',APP4_BY = 'N/A',APP4_DATE = '" & CDATE(NOW) & "',PURC_OTHERS = '" & TRIM(replace(txtOthers.text,"'","`")) & "' where scar_no = '" & trim(lblScarNo.text) & "';")
    
        'Generate Gate Pass here
    
    
    
        ShowAlert("Selected SCAR has been submitted.")
        redirectPage("SCARApp3Det.aspx?ID=" & Request.params("ID"))
    End Sub
                                                ...
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <asp:RadioButton id="RadioButton3" runat="server" Text="IQC Reject" CssClass="OutputText"></asp:RadioButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <asp:RadioButton id="RadioButton4" runat="server" Text="Production Claim" CssClass="OutputText"></asp:RadioButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtDefDesc" runat="server" CssClass="OutputText" ReadOnly="True" Height="52px" Width="100%"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="60%" colspan="2">
                                                                ...
                                                                :-</asp:Label>&nbsp;&nbsp; 
                                                                <asp:RadioButton id="rbSort" runat="server" Text="Sort/Rework" GroupName="PurcDisp"></asp:RadioButton>
                                                                &nbsp;&nbsp; 
                                                                <asp:RadioButton id="rbRTV" runat="server" Text="RTV" GroupName="PurcDisp"></asp:RadioButton>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                :-</asp:Label>&nbsp;&nbsp; 
                                                                <asp:TextBox id="txtOthers" runat="server" CssClass="OutputText" Width="490px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtDefCause" runat="server" CssClass="OutputText" ReadOnly="True" Height="62px" Width="100%"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtActionTaken" runat="server" CssClass="OutputText" ReadOnly="True" Height="56px" Width="100%"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
