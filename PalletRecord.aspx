...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select pm.pallet_status,pm.seq_no,PM.PPR_NO,PM.jo_no,submit_by,submit_date,app1_by,app1_date,app2_by,app2_date from pallet_Record_M PM where " & trim(cmbBy.selecteditem.value) & " like '%" & trim(txtSearch.text) & "%' order by seq_no desc"
        IF StrSql <> "" THEN
    ...
    Sub ShowPalletRecord(sender as Object,e as DataGridCommandEventArgs)
        ...
        Response.redirect("PalletRecordDet.aspx?ID=" & SeqNo.text)
    End sub
    ...
    Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            if SubmitBy.text = "" then e.Item.CssClass = "PartSource"
        End if
    End Sub
    ...
    Sub cmdAddNew_Click(sender As Object, e As EventArgs)
        Response.redirect("PalletRecordAddNew.aspx")
    End Sub
                                                    ...
                                                    <table style="HEIGHT: 8px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        &nbsp;<asp:Button id="cmdAddNew" onclick="cmdAddNew_Click" runat="server" Text="New Pallet Record"></asp:Button>
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                    <div align="right">
