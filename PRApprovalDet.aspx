    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.isPostBack = false then
            ...
            Do while RsApproval.read
                ...
                lblSubmissionDate.text = format(RsApproval("Submit_date"),"MM/dd/yy")
                if isdbnull(RsApproval("Approve_Date")) = false then
                    lblDateApproved.text = format(cdate(RsApproval("Submit_date")),"MM/dd/yy")
                    lblApprovedBy.text = trim(RsApproval("Approve_By"))
                                                ...
                                                <table style="HEIGHT: 23px" width="100%" border="1">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label id="lblApprovalNo" runat="server" cssclass="OutputText" width="84px"></asp:Label></td>
                                                            <td>
                                                                <asp:Label id="Label3" runat="server" cssclass="LabelNormal">Submission Date</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblSubmissionDate" runat="server" cssclass="OutputText" width="106px"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label id="Label4" runat="server" cssclass="LabelNormal">Date Approved</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblDateApproved" runat="server" cssclass="OutputText" width="106px"></asp:Label></td>
                                                            <td>
                                                                <asp:Label id="Label5" runat="server" cssclass="LabelNormal">Approved By</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblApprovedBy" runat="server" cssclass="OutputText" width="106px"></asp:Label></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <p>
                                                ...
                                                <p>
                                                    <table style="HEIGHT: 17px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button id="cmdApprove" onclick="cmdApprove_Click" runat="server" Width="103px" Text="Approve"></asp:Button>
                                                                </td>
                                                                <td>
                                                                    <div align="center">
                                                                        <asp:Button id="cmdReject" onclick="cmdReject_Click" runat="server" Width="103px" Text="Reject"></asp:Button>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div align="right">
