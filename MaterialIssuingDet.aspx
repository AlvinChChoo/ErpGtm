                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td bgcolor="silver">
                                                                ...
                                                                No</asp:Label></td>
                                                            <td>
                                                                <asp:Label id="lblJONo" runat="server" width="223px" cssclass="OutputText"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td bgcolor="silver">
                                                                <asp:Label id="Label6" runat="server" width="126px" cssclass="LabelNormal">Lot No</asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td bgcolor="silver">
                                                                <asp:Label id="Label2" runat="server" width="126px" cssclass="LabelNormal">Issued
                                                    ...
                                                    <asp:DataGrid id="dtgPartList" runat="server" width="100%" BorderColor="Black" GridLines="None" cellpadding="4" Font-Name="Verdana" AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="XX-Small" OnSortCommand="SortGrid" AllowSorting="True" OnItemDataBound="FormatRow" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PageSize="100" Height="35px">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn HeaderText="Main Part">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label id="Type" width="60px" visible= "false" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Type") %>' /> <asp:Label id="MainPart" cssclass="OutputText" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Main_Part") %>' /> <asp:Label id="MainAlt" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Main_Alt") %>' /> <asp:Label id="SeqNo" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Seq_No") %>' visible= "false" /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="Part To Issue / Description / Specification">
                                                                <ItemTemplate>
                                                                    <asp:Label id="PartNo" cssclass="OutputText" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Part_No") %>' /> - <asp:Label id="PartDesc" runat="server" cssclass="OutputText" text='<%# DataBinder.Eval(Container.DataItem, "Part_Desc") %>' /> - <asp:Label id="PartSpec" cssclass="OutputText" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "Part_Spec") %>' /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                ...
                                                <p>
                                                    <table style="HEIGHT: 18px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button id="cmdUpdate" onclick="cmdUpdate_Click" runat="server" Text="Update" Width="122px"></asp:Button>
                                                                </td>
                                                                <td>
                                                                    <div align="center">
                                                                        <asp:Button id="cmdRemove" onclick="cmdRemove_Click" runat="server" Text="Remove this Issuing" Width="168px" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div align="right">
                                                                        <asp:Button id="cmdBack" onclick="cmdBack_Click" runat="server" Text="Back" Width="141px" CausesValidation="False"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
