...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        if page.isPostBack = false then
            ...
            do while rs.read
                ...
                'if rs("IQC_Rej") = "Y" then rbIR.checked = true
                'if rs("Prod_Rej") = "Y" then rbPR.checked = true
                ...
                if isdbnull(rs("App1_By")) = true then
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        response.redirect("SCARApp1.aspx")
    End Sub
    ...
    Sub cmdSubmit_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            ReqCOM.executeNonQuery("Update SCAR set App1_By = '" & trim(request.cookies("U_ID").value) & "',App1_Date = '" & cdate(now) & "',prod_rej = '" & trim(PR) & "',IQC_REJ = '" & trim(IR) & "',App1_Status = 'Y',Def_Desc = '" & trim(replace(txtDefDesc.text,"'","`")) & "',Def_Cause = '" & trim(replace(txtDefCause.text,"'","`")) & "',Action_Taken = '" & trim(replace(txtActionTaken.text,"'","`")) & "' where scar_no = '" & trim(lblScarNo.text) & "';")
            ShowAlert("Selected SCAR has been submitted.")
            redirectPage("SCARApp1Det.aspx?ID=" & Request.params("ID"))
        End if
    End Sub
    ...
    Sub valRej_ServerValidate(sender As Object, e As ServerValidateEventArgs)
        if (rbIR.checked = false) and (rbPR.checked = false) then e.isvalid = false
    End Sub
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p align="center">
                                <asp:CustomValidator id="valRej" runat="server" ErrorMessage="You don't seem to have supplied a valid reject detected." Display="Dynamic" ForeColor=" " OnServerValidate="valRej_ServerValidate" EnableClientScript="False" Width="100%" CssClass="ErrorText"></asp:CustomValidator>
                            </p>
                            <p>
                                                ...
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <asp:RadioButton id="rbIR" runat="server" CssClass="OutputText" GroupName="RejReason" Text="IQC Reject"></asp:RadioButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <asp:RadioButton id="rbPR" runat="server" CssClass="OutputText" GroupName="RejReason" Text="Production Claim"></asp:RadioButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtDefDesc" runat="server" Width="100%" CssClass="OutputText" Height="49px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="60%">
                                                                ...
                                                                :-</asp:Label>&nbsp;&nbsp;
                                                                <asp:RadioButton id="rbSort" runat="server" GroupName="PurcDisp" Text="Sort/Rework" Enabled="False"></asp:RadioButton>
                                                                &nbsp;&nbsp;
                                                                <asp:RadioButton id="rbRTV" runat="server" GroupName="PurcDisp" Text="RTV" Enabled="False"></asp:RadioButton>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                :-</asp:Label>&nbsp;&nbsp;
                                                                <asp:TextBox id="TextBox4" runat="server" Width="512px" Enabled="False"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtDefCause" runat="server" Width="100%" CssClass="OutputText" Height="54px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td>
                                                <table style="HEIGHT: 48px" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox id="txtActionTaken" runat="server" Width="100%" CssClass="OutputText" Height="48px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
            ...
            <table style="HEIGHT: 10px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    <tr>
                        <td width="50%">
                            <p align="left">
                                <asp:Button id="cmdSubmit" onclick="cmdSubmit_Click" runat="server" Width="133px" Text="Submit"></asp:Button>
                            </p>
                        </td>
                        <td width="50%">
                            <div align="right">
