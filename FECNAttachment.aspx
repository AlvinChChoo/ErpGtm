...
<script runat="server">
    ...
    Sub Button1_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            Response.redirect("FECNAttachment.aspx?ID=" & Request.params("ID") & "&ReturnURL=" & trim(Request.params("ReturnURL")))
        end if
    End Sub
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p>
                                                    <asp:DataGrid id="dtgModelPic" runat="server" width="100%" PageSize="50" AlternatingItemStyle-CssClass="CartListItemAlt" ItemStyle-CssClass="CartListItem" HeaderStyle-CssClass="CartListHead" AutoGenerateColumns="False" cellpadding="4" BorderColor="Gray" OnSelectedIndexChanged="dtgModelPic_SelectedIndexChanged">
                                                ...
                                                <p>
                                                    <table style="HEIGHT: 13px" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button id="cmdDelete" onclick="cmdDelete_Click" runat="server" Width="147px" CssClass="OutputText" Text="Remove Attachment" CausesValidation="False"></asp:Button>
                                                                </td>
                                                                <td>
                                                                    <p align="right">
                                                                        <asp:Button id="cmdExit" onclick="cmdExit_Click" runat="server" Width="147px" CssClass="OutputText" Text="Back"></asp:Button>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
