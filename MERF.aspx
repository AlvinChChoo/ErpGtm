...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        StrSql = "Select SM.Model_No,MM.MERF_NO,MM.JO_No,MM.P_Level,MM.Submit_By,MM.Submit_Date,MM.App1_By,MM.App2_By,MM.App3_By,MM.App1_Date,MM.App2_Date,MM.App3_Date,MM.MERF_Status,JM.Lot_No from merf_m MM,Job_Order_M JM,SO_Models_M SM where mm.jo_no = jm.jo_no and jm.lot_no = sm.lot_no order by MERF_No desc"
    ...
    Sub cmdAdd_Click(sender As Object, e As EventArgs)
         Response.redirect("MERFAddNew.aspx")
    End Sub
                                                    ...
                                                    <table style="HEIGHT: 25px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td width="50%">
                                                                    <div align="left">
                                                                        <asp:Button id="cmdAdd" onclick="cmdAdd_Click" runat="server" Text="Register new Extra Req. Form" Width="208px"></asp:Button>
                                                                    </div>
                                                                </td>
                                                                <td width="50%">
                                                                    <div align="right">
