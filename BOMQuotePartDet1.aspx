...
<script runat="server">
    ...
    Sub LoadData()
        ...
        do while drGetFieldVal.read
            ...
            txtSPQ.text = drGetFieldVal("SPQ").toString
            txtMOQ.text = drGetFieldVal("MOQ").toString
            txtLowestUP.text = drGetFieldVal("Lowest_UP").toString
            txtHighestUP.text = drGetFieldVal("Highest_Up").toString
            txtRem.text = drGetFieldVal("Rem").toString
            txtLeadTime.text = drGetFieldVal("Lead_Time").toString
            txtVenName.text = drGetFieldVal("Ven_Name").toString
            lblOriCurr.text = drGetFieldVal("Target_Ori_Curr").toString
            txtOriUP.text = drGetFieldVal("Target_Ori_UP").toString
            txtUPRM.text = drGetFieldVal("Target_UP_RM").toString
        loop
        myCommand.dispose()
        drGetFieldVal.close()
        cnnGetFieldVal.Close()
    ...
    Sub SearchPart()
        ...
        '    txtVenName.enabled = true
        '    txtLeadTime.enabled = true
        '    txtSPQ.enabled = true
        '    lblSPQUsage.enabled = true
        '    txtMOQ.enabled = true
        '    lblMOQUsage.enabled = true
        '    txtLowestUP.enabled = true
        '    txtLowestAmt.enabled = true
        '    txtHighestUP.enabled = true
        '    txtHighestAmt.enabled = true
        'else
        ...
        '    txtVenName.enabled = false
        '    txtLeadTime.enabled = false
        '    txtSPQ.enabled = false
        '    lblSPQUsage.enabled = false
        '    txtMOQ.enabled = false
        '    lblMOQUsage.enabled = false
        ...
        if trim(lblSelPartNo.text) <> "" then
            if ReqCOm.GetFieldVal("Select Highest_UP from Part_Master where part_no = '" & trim(lblSelPartNo.text) & "'","Highest_UP") = 0 then
                ...
                do while drGetFieldVal.read
                    ...
                    Rate = ReqCOM.GetFieldVal("Select Rate from BOM_Quote_Curr where BOM_Quote_No = '" & trim(lblBOMQuoteNo.text) & "' and Curr_Code = '" & trim(lblOriCurr.text) & "';","Rate")
                    UnitConv = ReqCOM.GetFieldVal("Select Unit_Conv from BOM_Quote_Curr where BOM_Quote_No = '" & trim(lblBOMQuoteNo.text) & "' and Curr_Code = '" & trim(lblOriCurr.text) & "';","Unit_Conv")
    ...
    Sub cmdSaveAndExit_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            ...
            ReqCOM.ExecuteNonQUery("Update BOM_Quote_D set Rem = '" & trim(replace(txtRem.text,"'","`")) & "', P_Usage = " & cdec(txtPUsage.text) & " where bom_quote_no = '" & trim(lblBOMQuoteNo.text) & "' and main_Part = '" & trim(lblMainPart.text) & "';")
            response.redirect("BOMQuoteDet.aspx?ID=" & ReqCOM.getFieldVal("select Seq_No from bom_quote_m where bom_quote_no = '" & trim(lblBOMQuoteNo.text) & "';","Seq_No"))
    ...
    Sub CalculateQty()
        Dim ReqCOM as ERP_GTM.ERP_GTM = new ERP_GTM.ERP_GTM
        Dim Rate as Decimal
        Rate = ReqCOM.GetFieldVal("Select Rate/Unit_Conv as [Rate] from Curr where Curr_Code = '" & trim(lblOriCurr.text) & "';","Rate")
            ...
            <table style="HEIGHT: 14px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label1" runat="server" forecolor="" backcolor="" width="100%" cssclass="FormDesc">BOM
                                QUOTATION - PART DETAILS</asp:Label>
                            </p>
                            <p align="center">
                                        ...
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    ...
                                                    <asp:CompareValidator id="CompareValidator4" runat="server" ControlToValidate="txtPUsage" Display="Dynamic" ForeColor=" " ErrorMessage="Usage must be an integer/decimal value." CssClass="ErrorText" Width="100%" Type="Double" Operator="DataTypeCheck"></asp:CompareValidator>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="25%" bgcolor="silver">
                                                                    <asp:Label id="Label2" runat="server" width="128px" cssclass="LabelNormal">Quotation
                                                                    #</asp:Label></td>
                                                                <td width="75%" colspan="3">
                                                                    <p>
                                                                        <asp:Label id="lblBOMQuoteNo" runat="server" cssclass="OutputText"></asp:Label><asp:Label id="lblSelPartNo" runat="server" cssclass="OutputText" visible="False"></asp:Label><asp:Label id="Label10" runat="server" cssclass="OutputText" visible="False"></asp:Label>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <asp:Label id="lblBOMQuoteRev" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label3" runat="server" width="131px" cssclass="LabelNormal">Part #</asp:Label></td>
                                                                <td colspan="3">
                                                                    <asp:Label id="lblPartNo" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label20" runat="server" width="131px" cssclass="LabelNormal">Customer
                                                                    Part #</asp:Label></td>
                                                                <td colspan="3">
                                                                    <p>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label6" runat="server" width="105px" cssclass="LabelNormal">Specification</asp:Label></td>
                                                                <td colspan="3">
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label7" runat="server" width="121px" cssclass="LabelNormal">Mfg Name</asp:Label></td>
                                                                <td colspan="3">
                                                                    <p>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label8" runat="server" width="122px" cssclass="LabelNormal">Manufacturer
                                                                    Part #</asp:Label></td>
                                                                <td colspan="3">
                                                                    <p>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label9" runat="server" width="122px" cssclass="LabelNormal">Usage</asp:Label></td>
                                                                <td>
                                                                    <p>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label4" runat="server" width="122px" cssclass="LabelNormal">Target
                                                                    Ori. Curr</asp:Label></td>
                                                                <td>
                                                                    <p>
                                                                        <asp:Label id="lblOriCurr" runat="server" cssclass="OutputText"></asp:Label><asp:Label id="txtOriCurr1" runat="server"></asp:Label>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label23" runat="server" width="100%" cssclass="LabelNormal">Target
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label12" runat="server" width="122px" cssclass="LabelNormal">Target
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label27" runat="server" width="122px" cssclass="LabelNormal">Target
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label28" runat="server" width="122px" cssclass="LabelNormal">Target
                                                                    Amt (RM)</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label29" runat="server" width="122px" cssclass="LabelNormal">Supplier</asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox id="txtVenName" runat="server" CssClass="OutputText" Width="163px" Enabled="False"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label30" runat="server" width="122px" cssclass="LabelNormal">Lead Time</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label31" runat="server" width="122px" cssclass="LabelNormal">SPQ</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label32" runat="server" width="122px" cssclass="LabelNormal">SPQ/Usage</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblSPQUsage" runat="server" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label33" runat="server" width="122px" cssclass="LabelNormal">MOQ</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label34" runat="server" width="122px" cssclass="LabelNormal">MOQ/Usage</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblMOQUsage" runat="server" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label35" runat="server" width="122px" cssclass="LabelNormal">Lowest
                                                                    U. Cost(RM)</asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox id="txtLowestUP" runat="server" CssClass="ReqText" Width="163px" Enabled="False"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label36" runat="server" width="122px" cssclass="LabelNormal">Lowest
                                                                    Amt(RM)</asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox id="txtLowestAmt" runat="server" CssClass="OutputText" Width="163px" Enabled="False"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label37" runat="server" width="122px" cssclass="LabelNormal">Highest
                                                                    U.Cost(RM)</asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox id="txtHighestUP" runat="server" CssClass="ReqText" Width="163px" Enabled="False"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label38" runat="server" width="122px" cssclass="LabelNormal">Highest
                                                                    Amt(RM)</asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox id="txtHighestAmt" runat="server" CssClass="OutputText" Width="163px" Enabled="False"></asp:TextBox>
                                                                    &nbsp;
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label39" runat="server" width="122px" cssclass="LabelNormal">Remarks</asp:Label></td>
                                                                <td>
