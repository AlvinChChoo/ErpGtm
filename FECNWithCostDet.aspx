...
<script runat="server">
    ...
    Sub cmdBack_Click(sender As Object, e As EventArgs)
        Response.redirect("FECNWithCost.aspx")
    End Sub
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                                ...
                                                                <td>
                                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: white; BORDER-BOTTOM-COLOR: white; BORDER-TOP-COLOR: white; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: white" width="100%" align="center" border="1">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    <asp:CheckBox id="chkToGTTMgt" runat="server" CssClass="OutputText" Text="E-Mail to GTT (Ms Regina)"></asp:CheckBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label id="lblFECNNo" runat="server" width="" cssclass="OutputText" font-bold="True" font-size="Larger"></asp:Label></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                            ...
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                                                    <asp:Label id="Label14" runat="server" width="116px" cssclass="LabelNormal">PCBA Rev.
                                                                                    To</asp:Label></td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:TextBox id="txtOthers" runat="server" Enabled="False" CssClass="OutputText" Width="433px" TextMode="MultiLine"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td bgcolor="silver">
                                                ...
                                                <p align="center">
                                                    <asp:Label id="Label11" runat="server" width="96%" cssclass="SectionHeader">FECN ATTACHMENT</asp:Label> 
                                                ...
                                                <p align="center">
                                                    <table style="HEIGHT: 27px" cellspacing="0" cellpadding="0" width="96%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div align="center"><asp:Label id="Label12" runat="server" width="100%" cssclass="SectionHeader">FECN
                                                                        DETAILS</asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table class="sideboxnotop" style="HEIGHT: 13px" width="100%" align="center">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <p>
                                                                                        <asp:DataList id="MyList" runat="server" Width="100%" OnSelectedIndexChanged="MyList_SelectedIndexChanged" Height="101px" CellPadding="1" BorderWidth="0px" RepeatColumns="1" Font-Size="XX-Small" Font-Names="Arial" OnItemCommand="ShowDetails">
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label id="RowNo" visible="true" cssclass="ErrorText" runat="server" text='11' /> <span class="ListLabel"> <span class="ListLabel">Type
                                                                                                            Of Changes : </span><span class="ListOutput"><asp:Label id="typechange" cssclass="ListOutput" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "TYPE_CHANGE") %>'></asp:Label> </span> 
