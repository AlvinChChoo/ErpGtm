...
<script runat="server">
    ...
    Sub ProcLoadGridData()
        ...
        Dim StrSql as string = "Select * from pr1_m where App2_Date is not null order by Seq_No desc"
    ...
    Sub ItemCommand(sender as Object,e as DataGridCommandEventArgs)
        ...
        if ucase(e.commandArgument) = "VIEW" then Response.redirect("PRApp3Det.aspx?ID=" & clng(SeqNo.text))
    end sub
