...
<script runat="server">
    ...
    Sub cmdCancel_Click(sender As Object, e As EventArgs)
        response.redirect("BOMQuoteApp1.aspx")
    End Sub
    ...
    Sub ShowDet(sender as Object,e as DataGridCommandEventArgs)
        ...
        if trim(ucase(e.commandArgument)) = "VIEW" then Response.redirect("BOMQuotePartDetApp1.aspx?ID=" & trim(SeqNo.text))
            ...
            <table height="0px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label1" runat="server" width="100%" cssclass="FormDesc">PART LIST</asp:Label>
                            </p>
                            <p align="center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" nowrap="nowrap" align="left" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="30%" bgcolor="silver">
                                                                    <asp:Label id="Label2" runat="server" width="100%" cssclass="LabelNormal">Quotation
                                                                    #</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label6" runat="server" width="100%" cssclass="LabelNormal">Revision</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblBOMQuoteRev" runat="server" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label3" runat="server" width="100%" cssclass="LabelNormal">Model No
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label4" runat="server" width="100%" cssclass="LabelNormal">Customer</asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label5" runat="server" width="100%" cssclass="LabelNormal">Target Cost</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblTargetCost" runat="server" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label7" runat="server" width="100%" cssclass="LabelNormal">View Report</asp:Label></td>
                                                                <td>
                                                                    <asp:DropDownList id="cmbReport" runat="server" CssClass="OutputText" Width="494px">
                                                                    ...
                                                                    <asp:Button id="cmdViewRpt" onclick="cmdViewRpt_Click" runat="server" CssClass="OutputText" Width="62px" Text="GO"></asp:Button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table style="HEIGHT: 16px" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p align="center">
                                                                        <asp:Label id="Label15" runat="server" cssclass="OutputText">SEARCH</asp:Label>&nbsp;&nbsp;<asp:TextBox id="txtSearch" runat="server" CssClass="OutputText" Width="176px"></asp:TextBox>
                                                                        &nbsp; <asp:Label id="Label16" runat="server" cssclass="OutputText">BY</asp:Label>&nbsp; 
                                                                        <asp:DropDownList id="cmbSearchField" runat="server" CssClass="OutputText" Width="172px">
                                                                        ...
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                        <asp:Button id="cmdGO" onclick="cmdGO_Click" runat="server" CssClass="OutputText" Width="58px" Text="GO" CausesValidation="False"></asp:Button>
                                                                        &nbsp; 
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                ...
                                                <p>
                                                    <asp:DataGrid id="GridControl1" runat="server" width="100%" OnItemCommand="ShowDet" PageSize="20" BorderColor="Black" GridLines="Vertical" cellpadding="4" ShowFooter="True" AutoGenerateColumns="False" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" AllowPaging="True" OnPageIndexChanged="OurPager" OnSortCommand="SortGrid" OnItemDataBound="FormatRow">
