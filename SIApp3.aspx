    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
         ...
         Sub ProcLoadGridData()
             ...
             if cmbSearch.selecteditem.value = "REF_NO" then
                 StrSql = "Select * from VENDOR_INFO where REF_NO like '%" & trim(txtSearch.text) & "%' and App2_Date is not null order by seq_no desc"
             elseif cmbSearch.selecteditem.value = "COMPANY_NAME" then
                 StrSql = "Select * from VENDOR_INFO where COMPANY_NAME like '%" & trim(txtSearch.text) & "%' and App2_Date is not null order by seq_no desc"
             end if
         ...
         Sub ShowData(sender as Object,e as DataGridCommandEventArgs)
             ...
             Response.redirect("SIApp3Det.aspx?ID=" & SeqNo)
         End sub
