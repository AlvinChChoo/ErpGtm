...
<script runat="server">
    ...
    Sub cmdGO_Click(sender As Object, e As EventArgs)
        ...
        ShowReport("PopupReportViewer.aspx?RptName=MaterialIssuingJOLevel&LotNo=" & trim(lblLotNo.text) & "&LotSize=" & clng(lblLotSize.text) & "&JONo=" & trim(txtJONo.text) & "&JOSize=" & clng(lblJoSize.text) & "&Level=" & trim(cmbLevel.selecteditem.value) & "&ModelDet=" & trim(lblModelNo.text) & "-" & trim(lblModelDesc.text))
        redirectPage("MaterialIssuingTracking.aspx")
    End Sub
                                                    ...
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; WIDTH: 100%; BORDER-TOP-COLOR: black; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: black" width="100%" border="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="75%">
                                                                    <asp:TextBox id="txtJONo" runat="server" CssClass="OutputText" Width="254px"></asp:TextBox>
                                                                    &nbsp; 
                                                                    <asp:Button id="Button1" onclick="Button1_Click" runat="server" CssClass="OutputText" Width="64px" Text="GO"></asp:Button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label2" runat="server" width="100%">Level</asp:Label></td>
                                                                <td>
                                                                    <asp:DropDownList id="cmbLevel" runat="server" CssClass="OutputText" Width="254px" OnSelectedIndexChanged="cmbLevel_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                ...
                                                                <td>
                                                                    <asp:Label id="lblJOSize" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
