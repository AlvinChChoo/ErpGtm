...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.isPostBack = false then
            Dissql ("Select Model_Code from Model_Master order by Model_Code asc","Model_Code","Model_Code",cmbModelFrom)
            Dissql ("Select Model_Code from Model_Master order by Model_Code asc","Model_Code","Model_Code",cmbModelTo)
    ...
    Sub Button1_Click(sender As Object, e As EventArgs)
        response.redirect("ReportViewer.aspx?RptName=SalesReportModel1&ModelFrom=" & trim(cmbModelFrom.selecteditem.value) & "&ModelTo=" & trim(cmbModelTo.selectedItem.value) & "&DateFrom=" & txtDateFrom1.text & "&DateTo=" & txtDateTo1.text & "&ReturnURL=SalesReportModel.aspx")
    End Sub
    ...
    Sub cmdRptByCust_Click(sender As Object, e As EventArgs)
        response.redirect("SalesByModelRpt1.aspx?RptType=Cust&RptName=SalesReportModel1&CustFrom=" & trim(cmbCustFrom.selecteditem.value) & "&CustTo=" & trim(cmbCustTo.selectedItem.value) & "&DateFrom=" & txtDateFrom2.text & "&DateTo=" & txtDateTo2.text)
    End Sub
    
    Sub cmdRptByDate_Click(sender As Object, e As EventArgs)
        response.redirect("SalesByModelRpt1.aspx?RptType=Date&RptName=SalesReportModel1&DateFrom=" & txtDateFrom3.text & "&DateTo=" & txtDateTo3.text)
    End Sub
                                                    ...
                                                    <table style="HEIGHT: 68px" width="100%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="3">
                                                                    <div align="center">
                                                                        <div align="center"><asp:Label id="Label1" runat="server" width="100%">SALES BY MODEL
                                                                            RANGE</asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                        ...
                                                                        <table style="HEIGHT: 38px" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <p align="center">
                                                                                            <asp:Label id="LotNo" runat="server" width="106px" cssclass="OutputText">Model From</asp:Label>
                                                                                            <asp:DropDownList id="cmbModelFrom" runat="server" Width="194px" CssClass="OutputText"></asp:DropDownList>
                                                                                            <asp:Label id="Label7" runat="server" width="23px" cssclass="OutputText">To</asp:Label>
                                                                                            <asp:DropDownList id="cmbModelTo" runat="server" Width="194px" CssClass="OutputText"></asp:DropDownList>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
