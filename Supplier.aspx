...
<script runat="server">
    ...
    Sub cmdAddNew_Click(sender As Object, e As EventArgs)
        response.redirect("SupplierAddNew.aspx")
    End Sub
    ...
    Sub ItemCommand(sender as Object,e as DataGridCommandEventArgs)
        ...
        if ucase(e.commandArgument) = "VIEW" then Response.redirect("SupplierDet.aspx?ID=" & clng(seqno.text))
    end sub
            ...
            <table style="HEIGHT: 631px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label1" runat="server" width="100%" cssclass="FormDesc">SUPPLIER LIST</asp:Label> 
                                        ...
                                        <tr>
                                            <td>
                                                <div align="center"><asp:Label id="Label7" runat="server" cssclass="OutputText">SEARCH</asp:Label>&nbsp; 
                                                    <asp:TextBox id="txtSearch" runat="server" Width="159px" CssClass="OutputText"></asp:TextBox>
                                                    &nbsp; <asp:Label id="Label5" runat="server" cssclass="OutputText">BY</asp:Label>&nbsp; 
                                                    <asp:DropDownList id="cmbSearchField" runat="server" Width="143px" CssClass="OutputText">
                                                                    ...
                                                                    <p>
                                                                        <asp:DataGrid id="GridControl1" runat="server" width="100%" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" PageSize="20" AllowPaging="True" BorderColor="Gray" cellpadding="4" ShowFooter="True" AutoGenerateColumns="False" Visible="False" OnPageIndexChanged="OurPager" PagerStyle-HorizontalAligh="Right" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" OnSortCommand="SortGrid" OnItemCommand="ItemCommand">
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateColumn>
                                                                                    <ItemTemplate>
                                                                                        <asp:ImageButton id="ImgView" ToolTip="View SUpplier Details" ImageUrl="View.gif" CommandArgument='VIEW' runat="server"></asp:ImageButton>
                                                    ...
                                                    <table style="HEIGHT: 12px" cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p>
                                                                        <asp:Button id="cmdNew" onclick="cmdAddNew_Click" runat="server" Width="173px" CssClass="OutputText" Text="Add New Supplier"></asp:Button>
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                    <div align="right">
                                                                        <asp:Button id="cmdBack" onclick="cmdBack_Click" runat="server" Width="151px" CssClass="OutputText" Text="Back"></asp:Button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
