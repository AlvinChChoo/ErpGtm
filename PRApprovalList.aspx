...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
         ...
         Sub ProcLoadGridData()
            ...
            Dim StrSql as string = "Select * from PR_Approval where PR_Status <> 'PENDING SUBMISSION' order by Seq_No desc"
    ...
    Protected Sub FormatRow(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
           ...
           if SubmitDate.text <> "" then SubmitDate.text = format(CDate(SubmitDate.text),"dd/MMM/yy")
           if ApproveDate.text <> "" then ApproveDate.text = format(CDate(ApproveDate.text),"dd/MMM/yy")
            ...
            <table style="HEIGHT: 16px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p align="center">
                                <asp:Label id="Label3" runat="server" width="100%" cssclass="FormDesc">PR APPROVAL
                                LIST</asp:Label>
                            </p>
                            <p align="center">
                                            ...
                                            <td>
                                                <p align="center">
                                                    <asp:DataGrid id="dtgShortage" runat="server" width="98%" OnItemDataBound="FormatRow" AutoGenerateColumns="False" Font-Size="XX-Small" Font-Name="Verdana" cellpadding="4" GridLines="Vertical" BorderColor="Black" PageSize="100" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" Font-Names="Verdana" Height="35px" AllowSorting="True" OnSortCommand="SortGrid">
                                                        ...
                                                        <Columns>
                                                            <asp:HyperLinkColumn Text="View" DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="PRApprovalDet.aspx?ID={0}"></asp:HyperLinkColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Date Approved">
                                                                ...
                                                                <ItemStyle horizontalalign="Right"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label id="ApproveDate" runat="server" align="right" columns="8" maxlength="6" text='<%# DataBinder.Eval(Container.DataItem, "approve_date") %>' /> 
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
