...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        if page.ispostback = false then
            ...
            if GridControl1.items.count = 0 then GridControl1.visible = false:lblRem.visible = true
            if GridControl1.items.count <> 0 then GridControl1.visible = true:lblRem.visible = false
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <asp:Label id="lblRem" runat="server" width="100%" cssclass="ErrorText">No Job Order
                                                created for this lot.</asp:Label>
                                                <asp:DataGrid id="GridControl1" runat="server" width="100%" PagerStyle-HorizontalAligh="Right" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" BorderColor="Black" GridLines="Vertical" cellpadding="4" AutoGenerateColumns="False" OnItemDataBound="FormatRow">
