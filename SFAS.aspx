...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Sub ProcLoadGridData
            Dim StrSql as string = "select app1_by,app2_by,app1_date,app2_date,sfas_status,submit_by,submit_date,seq_no,SFAS_NO from SFAS_M order by seq_no desc"
    ...
    Sub cmdAddNew_Click_1(sender As Object, e As EventArgs)
        ...
        ReqCOM.ExecuteNonQuery("Insert into SFAS_M(SFAS_No) select '" & trim(SFASNo) & "';")
        ...
        'Response.redirect("SFASNew.aspx")
    End Sub
    
    Sub cmdCopyNewSFAS_Click(sender As Object, e As EventArgs)
        Response.redirect("SFASCopyNew.aspx")
    End Sub
                        ...
                        <td>
                            ...
                            <div align="center">
                                <asp:DataGrid id="GridControl1" runat="server" width="90%" OnPageIndexChanged="OurPager" OnItemDataBound="FormatRow" Font-Names="Verdana" OnSelectedIndexChanged="GridControl1_SelectedIndexChanged" PagerStyle-HorizontalAligh="Right" PagerStyle-PrevPageText="Prev" PagerStyle-NextPageText="Next" PageSize="20" AllowPaging="True" BorderColor="Black" GridLines="Vertical" cellpadding="2" Font-Name="Verdana" Font-Size="XX-Small" ShowFooter="True" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn DataNavigateUrlField="seq_no" DataNavigateUrlFormatString="SFASDet.aspx?ID={0}" DataTextField="SFAS_No" HeaderText="SFAS #"></asp:HyperLinkColumn>
                            ...
                            <div align="center">
                                <table style="HEIGHT: 10px" cellspacing="0" cellpadding="0" width="90%">
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <asp:Button id="cmdAddNew" onclick="cmdAddNew_Click_1" runat="server" Text="New SFAS" Width="155px"></asp:Button>
                                            </td>
                                            <td>
                                                <asp:Button id="cmdCopyNewSFAS" onclick="cmdCopyNewSFAS_Click" runat="server" Text="Copy new SFAS"></asp:Button>
                                            </td>
                                            <td width="50%">
                                                <div align="right">
