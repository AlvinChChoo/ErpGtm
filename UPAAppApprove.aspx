...
<script runat="server">
    ...
    Sub GenerateMail()
        ...
        Receiver = ReqCOm.GetFieldVal("Select U_ID from Authority where module_name = 'UPA' and APP_TYPE = 'APP2.1'","U_ID")
        ...
        StrMsg = StrMsg + "Click on http://gtekapp/erp/signin.aspx?ReturnURL=UPAAcc1AppDet.aspx?ID=" & Request.params("ID") & " to view the details."   & vblf & vblf
    ...
    Sub cmdYes_Click(sender As Object, e As EventArgs)
        ...
        Dim ReqCOM AS erp_gtm.erp_gtm = NEW erp_gtm.erp_gtm
        ReqCOM.executenonquery("Update UPAS_M set PURC_STATUS = 'APPROVED', PURC_BY='" & TRIM(request.cookies("U_ID").value) & "',Purc_date = '" & now & "',PURC_REM = '" & TRIM(txtReason.text) & "' where seq_no = " & cint(request.params("ID")) & ";")
        'GenerateMail()
        ReturnURL = "UPAAppDet.aspx?ID=" & Request.params("ID")
                                ...
                                <table style="HEIGHT: 14px" cellspacing="0" cellpadding="0" width="98%">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p align="center">
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="txtReason" Display="Dynamic" ForeColor=" " ErrorMessage="You don't seem to have supplied a valid Reason for Approval." CssClass="ErrorText" Width="100%"></asp:RequiredFieldValidator>
                                                </p>
                                                <p>
                                                    <table style="FONT-SIZE: xx-small; BORDER-LEFT-COLOR: white; BORDER-BOTTOM-COLOR: white; BORDER-TOP-COLOR: white; FONT-FAMILY: Verdana; BORDER-COLLAPSE: collapse; BORDER-RIGHT-COLOR: white" width="80%" align="center" border="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="left"><asp:Label id="lblUPASNo" runat="server" width="100%" cssclass="OutputText"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label4" runat="server" cssclass="LabelNormal">Approved By</asp:Label></td>
                                                                <td>
                                                                    <asp:Label id="lblAppBy" runat="server" width="100%" cssclass="OutputText"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="silver">
                                                                    <asp:Label id="Label1" runat="server" cssclass="LabelNormal">Reason for approval</asp:Label></td>
                                                                <td>
                                                                    <div align="left">
                                                                        <asp:TextBox id="txtReason" runat="server" CssClass="OutputText" Width="100%" MaxLength="200"></asp:TextBox>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <p align="center">
                                                    <asp:Label id="Label2" runat="server" cssclass="Instruction">Are you sure to approve
