...
<script runat="server">
    ...
    Sub cmdGO_Click(sender As Object, e As EventArgs)
        if page.isvalid = true then
            if trim(txtPartNoFrom.text) = "" then txtPartNoFrom.text = trim(txtPartNoTo.text)
            if trim(txtPartNoTo.text) = "" then txtPartNoTo.text = trim(txtPartNoFrom.text)
            ShowPopup("PopupReportViewer.aspx?RptName=POOutstandingNoCost&ReturnURL=POOutstandingRpt.aspx&PartNoFrom=" & trim(txtPartNoFrom.text) & "&PartNoTo=" & trim(txtPartNoTo.text))
            redirectPage("POOutStandingNoCost.aspx")
    ...
    Sub ValInput_ServerValidate(sender As Object, e As ServerValidateEventArgs)
        if (trim(txtPartNoFrom.text) = "" and trim(txtPartNoTo.text) = "") then e.isvalid = false
    End Sub
        ...
        <p>
            <table style="HEIGHT: 8px" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div align="center"><asp:Label id="Label3" runat="server" width="100%" cssclass="FormDesc">Purchase
                                Order Outstanding Report</asp:Label>
                            </div>
                            <div align="center">
                            </div>
                            <div align="center">
                                <asp:CustomValidator id="ValInput" runat="server" ErrorMessage="You don't seem to have supplied a valid Part No range." Display="Dynamic" ForeColor=" " OnServerValidate="ValInput_ServerValidate" EnableClientScript="False" CssClass="ErrorText" Width="100%"></asp:CustomValidator>
                            </div>
                            <p>
                                                    ...
                                                    <table style="HEIGHT: 13px" cellspacing="0" cellpadding="0" width="100%" align="center">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="50%">
                                                                    <p align="right">
                                                                        <asp:Button id="cmdFinish" onclick="cmdFinish_Click" runat="server" Width="117px" Text="Back"></asp:Button>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
